...
==== +++<a class="heading-anchor" area-hidden="true" name=SkaleDKG-isLastDKGSuccesful-bytes32->isLastDKGSuccesful</a>+++ `++isLastDKGSuccesful(++[.var-type]#++bytes32++#++ ++[.var-name]#++groupIndex++#++) → ++[.var-type]#++bool++#++++` [.item-kind]#external#
