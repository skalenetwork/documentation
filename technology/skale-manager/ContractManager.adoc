...
.Functions
--
* <<ContractManager-initialize--,`++initialize()++`>>
* <<ContractManager-setContractsAddress-string-address-,`++setContractsAddress(contractsName, newContractsAddress)++`>>
* <<ContractManager-getContract-string-,`++getContract(name)++`>>
...
.Events
--
* <<ContractManager-ContractUpgraded-string-address-,`++ContractUpgraded(contractsName, contractsAddress)++`>>
