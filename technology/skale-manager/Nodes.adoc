...
:checkNodeExists: pass:normal[xref:#Nodes-checkNodeExists-uint256-[`++checkNodeExists++`]]
...
:validatorToNodeIndexes: pass:normal[xref:#Nodes-validatorToNodeIndexes-mapping-uint256----uint256---[`++validatorToNodeIndexes++`]]
...
:changeNodeFinishTime: pass:normal[xref:#Nodes-changeNodeFinishTime-uint256-uint256-[`++changeNodeFinishTime++`]]
:createNode: pass:normal[xref:#Nodes-createNode-address-struct-Nodes-NodeCreationParams-[`++createNode++`]]
:initExit: pass:normal[xref:#Nodes-initExit-uint256-[`++initExit++`]]
:completeExit: pass:normal[xref:#Nodes-completeExit-uint256-[`++completeExit++`]]
:deleteNodeForValidator: pass:normal[xref:#Nodes-deleteNodeForValidator-uint256-uint256-[`++deleteNodeForValidator++`]]
:checkPossibilityCreatingNode: pass:normal[xref:#Nodes-checkPossibilityCreatingNode-address-[`++checkPossibilityCreatingNode++`]]
:checkPossibilityToMaintainNode: pass:normal[xref:#Nodes-checkPossibilityToMaintainNode-uint256-uint256-[`++checkPossibilityToMaintainNode++`]]
:setNodeInMaintenance: pass:normal[xref:#Nodes-setNodeInMaintenance-uint256-[`++setNodeInMaintenance++`]]
:removeNodeFromInMaintenance: pass:normal[xref:#Nodes-removeNodeFromInMaintenance-uint256-[`++removeNodeFromInMaintenance++`]]
...
:isNodeInMaintenance: pass:normal[xref:#Nodes-isNodeInMaintenance-uint256-[`++isNodeInMaintenance++`]]
...
:getValidatorNodeIndexes: pass:normal[xref:#Nodes-getValidatorNodeIndexes-uint256-[`++getValidatorNodeIndexes++`]]
...
:NodeCreated: pass:normal[xref:#Nodes-NodeCreated-uint256-address-string-bytes4-bytes4-uint16-uint16-uint256-uint256-[`++NodeCreated++`]]
:ExitCompleted: pass:normal[xref:#Nodes-ExitCompleted-uint256-uint256-uint256-[`++ExitCompleted++`]]
:ExitInitialized: pass:normal[xref:#Nodes-ExitInitialized-uint256-uint256-uint256-uint256-[`++ExitInitialized++`]]

[.contract]
[[Nodes]]
= `++Nodes++`

This contract contains all logic to manage SKALE Network nodes states,
...
.Modifiers
--
* {xref-Nodes-checkNodeExists-uint256-}[`++checkNodeExists(nodeIndex)++`]
--
...
* {xref-Nodes-changeNodeFinishTime-uint256-uint256-}[`++changeNodeFinishTime(nodeIndex, time)++`]
* {xref-Nodes-createNode-address-struct-Nodes-NodeCreationParams-}[`++createNode(from, params)++`]
* {xref-Nodes-initExit-uint256-}[`++initExit(nodeIndex)++`]
* {xref-Nodes-completeExit-uint256-}[`++completeExit(nodeIndex)++`]
* {xref-Nodes-deleteNodeForValidator-uint256-uint256-}[`++deleteNodeForValidator(validatorId, nodeIndex)++`]
* {xref-Nodes-checkPossibilityCreatingNode-address-}[`++checkPossibilityCreatingNode(nodeAddress)++`]
* {xref-Nodes-checkPossibilityToMaintainNode-uint256-uint256-}[`++checkPossibilityToMaintainNode(validatorId, nodeIndex)++`]
* {xref-Nodes-setNodeInMaintenance-uint256-}[`++setNodeInMaintenance(nodeIndex)++`]
* {xref-Nodes-removeNodeFromInMaintenance-uint256-}[`++removeNodeFromInMaintenance(nodeIndex)++`]
...
* {xref-Nodes-isNodeInMaintenance-uint256-}[`++isNodeInMaintenance(nodeIndex)++`]
...
* {xref-Nodes-getValidatorNodeIndexes-uint256-}[`++getValidatorNodeIndexes(validatorId)++`]
* {xref-Nodes-initialize-address-}[`++initialize(contractsAddress)++`]
...
.Events
--
* {xref-Nodes-NodeCreated-uint256-address-string-bytes4-bytes4-uint16-uint16-uint256-uint256-}[`++NodeCreated(nodeIndex, owner, name, ip, publicIP, port, nonce, time, gasSpend)++`]
* {xref-Nodes-ExitCompleted-uint256-uint256-uint256-}[`++ExitCompleted(nodeIndex, time, gasSpend)++`]
* {xref-Nodes-ExitInitialized-uint256-uint256-uint256-uint256-}[`++ExitInitialized(nodeIndex, startLeavingPeriod, time, gasSpend)++`]
--

[.contract-item]
==== +++<a class="heading-anchor heading-anchor--h4" area-hidden="true" name=Nodes-checkNodeExists-uint256->checkNodeExists</a>+++ `++checkNodeExists(++[.var-type]#++uint256++#++ ++[.var-name]#++nodeIndex++#++)++` [.item-kind]#modifier#




[.contract-item]
==== +++<a class="heading-anchor heading-anchor--h4" area-hidden="true" name=Nodes-removeSpaceFromNode-uint256-uint8->removeSpaceFromNode</a>+++ `++removeSpaceFromNode(++[.var-type]#++uint256++#++ ++[.var-name]#++nodeIndex++#++, ++[.var-type]#++uint8++#++ ++[.var-name]#++space++#++) → ++[.var-type]#++bool++#++++` [.item-kind]#external#

Allows Schains and SchainsInternal contracts to occupy available
capacity on a node.
Returns boolean whether operation is successful.

[.contract-item]
==== +++<a class="heading-anchor heading-anchor--h4" area-hidden="true" name=Nodes-addSpaceToNode-uint256-uint8->addSpaceToNode</a>+++ `++addSpaceToNode(++[.var-type]#++uint256++#++ ++[.var-name]#++nodeIndex++#++, ++[.var-type]#++uint8++#++ ++[.var-name]#++space++#++)++` [.item-kind]#external#

Allows Schains contract to occupy available capacity on a node.
Returns boolean whether operation is successful.

[.contract-item]
==== +++<a class="heading-anchor heading-anchor--h4" area-hidden="true" name=Nodes-changeNodeLastRewardDate-uint256->changeNodeLastRewardDate</a>+++ `++changeNodeLastRewardDate(++[.var-type]#++uint256++#++ ++[.var-name]#++nodeIndex++#++)++` [.item-kind]#external#

Allows SkaleManager to change a node's last reward date.

[.contract-item]
==== +++<a class="heading-anchor heading-anchor--h4" area-hidden="true" name=Nodes-changeNodeFinishTime-uint256-uint256->changeNodeFinishTime</a>+++ `++changeNodeFinishTime(++[.var-type]#++uint256++#++ ++[.var-name]#++nodeIndex++#++, ++[.var-type]#++uint256++#++ ++[.var-name]#++time++#++)++` [.item-kind]#external#



[.contract-item]
==== +++<a class="heading-anchor heading-anchor--h4" area-hidden="true" name=Nodes-createNode-address-struct-Nodes-NodeCreationParams->createNode</a>+++ `++createNode(++[.var-type]#++address++#++ ++[.var-name]#++from++#++, ++[.var-type]#++struct Nodes.NodeCreationParams++#++ ++[.var-name]#++params++#++)++` [.item-kind]#external#

Allows SkaleManager contract to create new node and adds it to the
Nodes contract.
...
[.contract-item]
==== +++<a class="heading-anchor heading-anchor--h4" area-hidden="true" name=Nodes-initExit-uint256->initExit</a>+++ `++initExit(++[.var-type]#++uint256++#++ ++[.var-name]#++nodeIndex++#++) → ++[.var-type]#++bool++#++++` [.item-kind]#external#
...
[.contract-item]
==== +++<a class="heading-anchor heading-anchor--h4" area-hidden="true" name=Nodes-completeExit-uint256->completeExit</a>+++ `++completeExit(++[.var-type]#++uint256++#++ ++[.var-name]#++nodeIndex++#++) → ++[.var-type]#++bool++#++++` [.item-kind]#external#
...
[.contract-item]
==== +++<a class="heading-anchor heading-anchor--h4" area-hidden="true" name=Nodes-deleteNodeForValidator-uint256-uint256->deleteNodeForValidator</a>+++ `++deleteNodeForValidator(++[.var-type]#++uint256++#++ ++[.var-name]#++validatorId++#++, ++[.var-type]#++uint256++#++ ++[.var-name]#++nodeIndex++#++)++` [.item-kind]#external#
...
[.contract-item]
==== +++<a class="heading-anchor heading-anchor--h4" area-hidden="true" name=Nodes-checkPossibilityCreatingNode-address->checkPossibilityCreatingNode</a>+++ `++checkPossibilityCreatingNode(++[.var-type]#++address++#++ ++[.var-name]#++nodeAddress++#++)++` [.item-kind]#external#

Allows SkaleManager contract to check whether a validator has
...
[.contract-item]
==== +++<a class="heading-anchor heading-anchor--h4" area-hidden="true" name=Nodes-checkPossibilityToMaintainNode-uint256-uint256->checkPossibilityToMaintainNode</a>+++ `++checkPossibilityToMaintainNode(++[.var-type]#++uint256++#++ ++[.var-name]#++validatorId++#++, ++[.var-type]#++uint256++#++ ++[.var-name]#++nodeIndex++#++) → ++[.var-type]#++bool++#++++` [.item-kind]#external#
...
[.contract-item]
==== +++<a class="heading-anchor heading-anchor--h4" area-hidden="true" name=Nodes-setNodeInMaintenance-uint256->setNodeInMaintenance</a>+++ `++setNodeInMaintenance(++[.var-type]#++uint256++#++ ++[.var-name]#++nodeIndex++#++)++` [.item-kind]#external#



[.contract-item]
==== +++<a class="heading-anchor heading-anchor--h4" area-hidden="true" name=Nodes-removeNodeFromInMaintenance-uint256->removeNodeFromInMaintenance</a>+++ `++removeNodeFromInMaintenance(++[.var-type]#++uint256++#++ ++[.var-name]#++nodeIndex++#++)++` [.item-kind]#external#



[.contract-item]
==== +++<a class="heading-anchor heading-anchor--h4" area-hidden="true" name=Nodes-getNodesWithFreeSpace-uint8->getNodesWithFreeSpace</a>+++ `++getNodesWithFreeSpace(++[.var-type]#++uint8++#++ ++[.var-name]#++freeSpace++#++) → ++[.var-type]#++uint256[]++#++++` [.item-kind]#external#

Returns nodes with resource availability.

[.contract-item]
==== +++<a class="heading-anchor heading-anchor--h4" area-hidden="true" name=Nodes-isTimeForReward-uint256->isTimeForReward</a>+++ `++isTimeForReward(++[.var-type]#++uint256++#++ ++[.var-name]#++nodeIndex++#++) → ++[.var-type]#++bool++#++++` [.item-kind]#external#

Checks whether time for a node's reward has come.

[.contract-item]
==== +++<a class="heading-anchor heading-anchor--h4" area-hidden="true" name=Nodes-getNodeIP-uint256->getNodeIP</a>+++ `++getNodeIP(++[.var-type]#++uint256++#++ ++[.var-name]#++nodeIndex++#++) → ++[.var-type]#++bytes4++#++++` [.item-kind]#external#
...
[.contract-item]
==== +++<a class="heading-anchor heading-anchor--h4" area-hidden="true" name=Nodes-getNodePort-uint256->getNodePort</a>+++ `++getNodePort(++[.var-type]#++uint256++#++ ++[.var-name]#++nodeIndex++#++) → ++[.var-type]#++uint16++#++++` [.item-kind]#external#

Returns the port of a given node.

[.contract-item]
==== +++<a class="heading-anchor heading-anchor--h4" area-hidden="true" name=Nodes-getNodePublicKey-uint256->getNodePublicKey</a>+++ `++getNodePublicKey(++[.var-type]#++uint256++#++ ++[.var-name]#++nodeIndex++#++) → ++[.var-type]#++bytes32[2]++#++++` [.item-kind]#external#

Returns the public key of a given node.

[.contract-item]
==== +++<a class="heading-anchor heading-anchor--h4" area-hidden="true" name=Nodes-getNodeFinishTime-uint256->getNodeFinishTime</a>+++ `++getNodeFinishTime(++[.var-type]#++uint256++#++ ++[.var-name]#++nodeIndex++#++) → ++[.var-type]#++uint256++#++++` [.item-kind]#external#



[.contract-item]
==== +++<a class="heading-anchor heading-anchor--h4" area-hidden="true" name=Nodes-isNodeLeft-uint256->isNodeLeft</a>+++ `++isNodeLeft(++[.var-type]#++uint256++#++ ++[.var-name]#++nodeIndex++#++) → ++[.var-type]#++bool++#++++` [.item-kind]#external#

Checks whether a node has left the network.

[.contract-item]
==== +++<a class="heading-anchor heading-anchor--h4" area-hidden="true" name=Nodes-isNodeInMaintenance-uint256->isNodeInMaintenance</a>+++ `++isNodeInMaintenance(++[.var-type]#++uint256++#++ ++[.var-name]#++nodeIndex++#++) → ++[.var-type]#++bool++#++++` [.item-kind]#external#



[.contract-item]
==== +++<a class="heading-anchor heading-anchor--h4" area-hidden="true" name=Nodes-getNodeLastRewardDate-uint256->getNodeLastRewardDate</a>+++ `++getNodeLastRewardDate(++[.var-type]#++uint256++#++ ++[.var-name]#++nodeIndex++#++) → ++[.var-type]#++uint256++#++++` [.item-kind]#external#

Returns a given node's last reward date.

[.contract-item]
==== +++<a class="heading-anchor heading-anchor--h4" area-hidden="true" name=Nodes-getNodeNextRewardDate-uint256->getNodeNextRewardDate</a>+++ `++getNodeNextRewardDate(++[.var-type]#++uint256++#++ ++[.var-name]#++nodeIndex++#++) → ++[.var-type]#++uint256++#++++` [.item-kind]#external#

Returns a given node's next reward date.

[.contract-item]
==== +++<a class="heading-anchor heading-anchor--h4" area-hidden="true" name=Nodes-getNumberOfNodes-->getNumberOfNodes</a>+++ `++getNumberOfNodes() → ++[.var-type]#++uint256++#++++` [.item-kind]#external#

Returns the total number of registered nodes.

[.contract-item]
==== +++<a class="heading-anchor heading-anchor--h4" area-hidden="true" name=Nodes-getNumberOnlineNodes-->getNumberOnlineNodes</a>+++ `++getNumberOnlineNodes() → ++[.var-type]#++uint256++#++++` [.item-kind]#external#

Returns the total number of online nodes.
Online nodes are equal to the number of active plus leaving nodes.

[.contract-item]
==== +++<a class="heading-anchor heading-anchor--h4" area-hidden="true" name=Nodes-getActiveNodeIPs-->getActiveNodeIPs</a>+++ `++getActiveNodeIPs() → ++[.var-type]#++bytes4[]++#++ ++[.var-name]#++activeNodeIPs++#++++` [.item-kind]#external#

Returns IPs of active nodes.

[.contract-item]
==== +++<a class="heading-anchor heading-anchor--h4" area-hidden="true" name=Nodes-getActiveNodesByAddress-->getActiveNodesByAddress</a>+++ `++getActiveNodesByAddress() → ++[.var-type]#++uint256[]++#++ ++[.var-name]#++activeNodesByAddress++#++++` [.item-kind]#external#

Returns active nodes linked to the msg.sender (validator address).

[.contract-item]
==== +++<a class="heading-anchor heading-anchor--h4" area-hidden="true" name=Nodes-getActiveNodeIds-->getActiveNodeIds</a>+++ `++getActiveNodeIds() → ++[.var-type]#++uint256[]++#++ ++[.var-name]#++activeNodeIds++#++++` [.item-kind]#external#

Return active node IDs.

[.contract-item]
==== +++<a class="heading-anchor heading-anchor--h4" area-hidden="true" name=Nodes-getNodeStatus-uint256->getNodeStatus</a>+++ `++getNodeStatus(++[.var-type]#++uint256++#++ ++[.var-name]#++nodeIndex++#++) → ++[.var-type]#++enum Nodes.NodeStatus++#++++` [.item-kind]#external#

Return a given node's current status.

[.contract-item]
==== +++<a class="heading-anchor heading-anchor--h4" area-hidden="true" name=Nodes-getValidatorNodeIndexes-uint256->getValidatorNodeIndexes</a>+++ `++getValidatorNodeIndexes(++[.var-type]#++uint256++#++ ++[.var-name]#++validatorId++#++) → ++[.var-type]#++uint256[]++#++++` [.item-kind]#external#
...
[.contract-item]
==== +++<a class="heading-anchor heading-anchor--h4" area-hidden="true" name=Nodes-initialize-address->initialize</a>+++ `++initialize(++[.var-type]#++address++#++ ++[.var-name]#++contractsAddress++#++)++` [.item-kind]#public#

constructor in Permissions approach.

[.contract-item]
==== +++<a class="heading-anchor heading-anchor--h4" area-hidden="true" name=Nodes-getValidatorId-uint256->getValidatorId</a>+++ `++getValidatorId(++[.var-type]#++uint256++#++ ++[.var-name]#++nodeIndex++#++) → ++[.var-type]#++uint256++#++++` [.item-kind]#public#



[.contract-item]
==== +++<a class="heading-anchor heading-anchor--h4" area-hidden="true" name=Nodes-isNodeExist-address-uint256->isNodeExist</a>+++ `++isNodeExist(++[.var-type]#++address++#++ ++[.var-name]#++from++#++, ++[.var-type]#++uint256++#++ ++[.var-name]#++nodeIndex++#++) → ++[.var-type]#++bool++#++++` [.item-kind]#public#

isNodeExist - checks existence of Node at this address


[.contract-item]
==== +++<a class="heading-anchor heading-anchor--h4" area-hidden="true" name=Nodes-isNodeActive-uint256->isNodeActive</a>+++ `++isNodeActive(++[.var-type]#++uint256++#++ ++[.var-name]#++nodeIndex++#++) → ++[.var-type]#++bool++#++++` [.item-kind]#public#

Checks whether a node's status is Active.

[.contract-item]
==== +++<a class="heading-anchor heading-anchor--h4" area-hidden="true" name=Nodes-isNodeLeaving-uint256->isNodeLeaving</a>+++ `++isNodeLeaving(++[.var-type]#++uint256++#++ ++[.var-name]#++nodeIndex++#++) → ++[.var-type]#++bool++#++++` [.item-kind]#public#

Checks whether a node's status is Leaving.

[.contract-item]
==== +++<a class="heading-anchor heading-anchor--h4" area-hidden="true" name=Nodes-countNodesWithFreeSpace-uint8->countNodesWithFreeSpace</a>+++ `++countNodesWithFreeSpace(++[.var-type]#++uint8++#++ ++[.var-name]#++freeSpace++#++) → ++[.var-type]#++uint256++#++ ++[.var-name]#++count++#++++` [.item-kind]#public#

Returns number of nodes with free space.


[.contract-item]
==== +++<a class="heading-anchor heading-anchor--h4" area-hidden="true" name=Nodes-NodeCreated-uint256-address-string-bytes4-bytes4-uint16-uint16-uint256-uint256->NodeCreated</a>+++ `++NodeCreated(++[.var-type]#++uint256++#++ ++[.var-name]#++nodeIndex++#++, ++[.var-type]#++address++#++ ++[.var-name]#++owner++#++, ++[.var-type]#++string++#++ ++[.var-name]#++name++#++, ++[.var-type]#++bytes4++#++ ++[.var-name]#++ip++#++, ++[.var-type]#++bytes4++#++ ++[.var-name]#++publicIP++#++, ++[.var-type]#++uint16++#++ ++[.var-name]#++port++#++, ++[.var-type]#++uint16++#++ ++[.var-name]#++nonce++#++, ++[.var-type]#++uint256++#++ ++[.var-name]#++time++#++, ++[.var-type]#++uint256++#++ ++[.var-name]#++gasSpend++#++)++` [.item-kind]#event#

Emitted when a node is created.

[.contract-item]
==== +++<a class="heading-anchor heading-anchor--h4" area-hidden="true" name=Nodes-ExitCompleted-uint256-uint256-uint256->ExitCompleted</a>+++ `++ExitCompleted(++[.var-type]#++uint256++#++ ++[.var-name]#++nodeIndex++#++, ++[.var-type]#++uint256++#++ ++[.var-name]#++time++#++, ++[.var-type]#++uint256++#++ ++[.var-name]#++gasSpend++#++)++` [.item-kind]#event#

Emitted when a node completes a network exit.

[.contract-item]
==== +++<a class="heading-anchor heading-anchor--h4" area-hidden="true" name=Nodes-ExitInitialized-uint256-uint256-uint256-uint256->ExitInitialized</a>+++ `++ExitInitialized(++[.var-type]#++uint256++#++ ++[.var-name]#++nodeIndex++#++, ++[.var-type]#++uint256++#++ ++[.var-name]#++startLeavingPeriod++#++, ++[.var-type]#++uint256++#++ ++[.var-name]#++time++#++, ++[.var-type]#++uint256++#++ ++[.var-name]#++gasSpend++#++)++` [.item-kind]#event#
