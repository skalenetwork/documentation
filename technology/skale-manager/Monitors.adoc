...
:Monitors: pass:normal[xref:#Monitors[`++Monitors++`]]
:checkedNodes: pass:normal[xref:#Monitors-checkedNodes-mapping-bytes32----struct-Monitors-CheckedNode---[`++checkedNodes++`]]
:verdicts: pass:normal[xref:#Monitors-verdicts-mapping-bytes32----uint256-----[`++verdicts++`]]
:groupsForMonitors: pass:normal[xref:#Monitors-groupsForMonitors-mapping-bytes32----uint256---[`++groupsForMonitors++`]]
:lastVerdictBlocks: pass:normal[xref:#Monitors-lastVerdictBlocks-mapping-bytes32----uint256-[`++lastVerdictBlocks++`]]
:lastBountyBlocks: pass:normal[xref:#Monitors-lastBountyBlocks-mapping-bytes32----uint256-[`++lastBountyBlocks++`]]
:addMonitor: pass:normal[xref:#Monitors-addMonitor-uint256-[`++addMonitor++`]]
:deleteMonitor: pass:normal[xref:#Monitors-deleteMonitor-uint256-[`++deleteMonitor++`]]
:removeCheckedNodes: pass:normal[xref:#Monitors-removeCheckedNodes-uint256-[`++removeCheckedNodes++`]]
:sendVerdict: pass:normal[xref:#Monitors-sendVerdict-uint256-struct-Monitors-Verdict-[`++sendVerdict++`]]
:calculateMetrics: pass:normal[xref:#Monitors-calculateMetrics-uint256-[`++calculateMetrics++`]]
:setLastBountyBlock: pass:normal[xref:#Monitors-setLastBountyBlock-uint256-[`++setLastBountyBlock++`]]
:getCheckedArray: pass:normal[xref:#Monitors-getCheckedArray-bytes32-[`++getCheckedArray++`]]
:getLastBountyBlock: pass:normal[xref:#Monitors-getLastBountyBlock-uint256-[`++getLastBountyBlock++`]]
:getNodesInGroup: pass:normal[xref:#Monitors-getNodesInGroup-bytes32-[`++getNodesInGroup++`]]
:getNumberOfNodesInGroup: pass:normal[xref:#Monitors-getNumberOfNodesInGroup-bytes32-[`++getNumberOfNodesInGroup++`]]
:initialize: pass:normal[xref:#Monitors-initialize-address-[`++initialize++`]]
:addCheckedNode: pass:normal[xref:#Monitors-addCheckedNode-bytes32-struct-Monitors-CheckedNode-[`++addCheckedNode++`]]
:getLastReceivedVerdictBlock: pass:normal[xref:#Monitors-getLastReceivedVerdictBlock-uint256-[`++getLastReceivedVerdictBlock++`]]
:getLengthOfMetrics: pass:normal[xref:#Monitors-getLengthOfMetrics-bytes32-[`++getLengthOfMetrics++`]]
:MonitorCreated: pass:normal[xref:#Monitors-MonitorCreated-uint256-bytes32-uint256-uint256---uint256-uint256-[`++MonitorCreated++`]]
:VerdictWasSent: pass:normal[xref:#Monitors-VerdictWasSent-uint256-uint256-uint32-uint32-bool-uint256-uint256-uint256-[`++VerdictWasSent++`]]
:MetricsWereCalculated: pass:normal[xref:#Monitors-MetricsWereCalculated-uint256-uint32-uint32-uint256-uint256-[`++MetricsWereCalculated++`]]
:PeriodsWereSet: pass:normal[xref:#Monitors-PeriodsWereSet-uint256-uint256-uint256-uint256-[`++PeriodsWereSet++`]]
:MonitorRotated: pass:normal[xref:#Monitors-MonitorRotated-bytes32-uint256-[`++MonitorRotated++`]]

[.contract]
[[Monitors]]
=== `++Monitors++`

This contract contains all logic to manage the Node Monitoring Service
...
.Functions
--
* {xref-Monitors-addMonitor-uint256-}[`++addMonitor(nodeIndex)++`]
* {xref-Monitors-deleteMonitor-uint256-}[`++deleteMonitor(nodeIndex)++`]
* {xref-Monitors-removeCheckedNodes-uint256-}[`++removeCheckedNodes(nodeIndex)++`]
* {xref-Monitors-sendVerdict-uint256-struct-Monitors-Verdict-}[`++sendVerdict(fromMonitorIndex, verdict)++`]
* {xref-Monitors-calculateMetrics-uint256-}[`++calculateMetrics(nodeIndex)++`]
* {xref-Monitors-setLastBountyBlock-uint256-}[`++setLastBountyBlock(nodeIndex)++`]
* {xref-Monitors-getCheckedArray-bytes32-}[`++getCheckedArray(monitorIndex)++`]
* {xref-Monitors-getLastBountyBlock-uint256-}[`++getLastBountyBlock(nodeIndex)++`]
* {xref-Monitors-getNodesInGroup-bytes32-}[`++getNodesInGroup(monitorIndex)++`]
* {xref-Monitors-getNumberOfNodesInGroup-bytes32-}[`++getNumberOfNodesInGroup(monitorIndex)++`]
* {xref-Monitors-initialize-address-}[`++initialize(newContractsAddress)++`]
* {xref-Monitors-addCheckedNode-bytes32-struct-Monitors-CheckedNode-}[`++addCheckedNode(monitorIndex, checkedNode)++`]
* {xref-Monitors-getLastReceivedVerdictBlock-uint256-}[`++getLastReceivedVerdictBlock(nodeIndex)++`]
* {xref-Monitors-getLengthOfMetrics-bytes32-}[`++getLengthOfMetrics(monitorIndex)++`]
...
.Events
--
* {xref-Monitors-MonitorCreated-uint256-bytes32-uint256-uint256---uint256-uint256-}[`++MonitorCreated(nodeIndex, monitorIndex, numberOfMonitors, nodesInGroup, time, gasSpend)++`]
* {xref-Monitors-VerdictWasSent-uint256-uint256-uint32-uint32-bool-uint256-uint256-uint256-}[`++VerdictWasSent(fromMonitorIndex, toNodeIndex, downtime, latency, status, previousBlockEvent, time, gasSpend)++`]
* {xref-Monitors-MetricsWereCalculated-uint256-uint32-uint32-uint256-uint256-}[`++MetricsWereCalculated(forNodeIndex, averageDowntime, averageLatency, time, gasSpend)++`]
* {xref-Monitors-PeriodsWereSet-uint256-uint256-uint256-uint256-}[`++PeriodsWereSet(rewardPeriod, deltaPeriod, time, gasSpend)++`]
* {xref-Monitors-MonitorRotated-bytes32-uint256-}[`++MonitorRotated(monitorIndex, newNode)++`]
...
[.contract-item]
[[Monitors-addMonitor-uint256-]]
==== `++addMonitor(++[.var-type]#++uint256++#++ ++[.var-name]#++nodeIndex++#++)++` [.item-kind]#external#

Allows SkaleManager to create a monitoring group.
Emits MonitorCreated event.

[.contract-item]
[[Monitors-deleteMonitor-uint256-]]
==== `++deleteMonitor(++[.var-type]#++uint256++#++ ++[.var-name]#++nodeIndex++#++)++` [.item-kind]#external#

Allows SkaleManager to delete a monitoring group.

[.contract-item]
[[Monitors-removeCheckedNodes-uint256-]]
==== `++removeCheckedNodes(++[.var-type]#++uint256++#++ ++[.var-name]#++nodeIndex++#++)++` [.item-kind]#external#

Allows SkaleManager contract to remove a node from a monitor group.

[.contract-item]
[[Monitors-sendVerdict-uint256-struct-Monitors-Verdict-]]
==== `++sendVerdict(++[.var-type]#++uint256++#++ ++[.var-name]#++fromMonitorIndex++#++, ++[.var-type]#++struct Monitors.Verdict++#++ ++[.var-name]#++verdict++#++)++` [.item-kind]#external#

Allows SkaleManager contract to send a monitoring verdict.
Emits VerdictWasSent event.
Requirements:
- Node must exist in the monitor group.

[.contract-item]
[[Monitors-calculateMetrics-uint256-]]
...
Allows SkaleManager to calculate median statistics of downtime
and latency.

[.contract-item]
[[Monitors-setLastBountyBlock-uint256-]]
==== `++setLastBountyBlock(++[.var-type]#++uint256++#++ ++[.var-name]#++nodeIndex++#++)++` [.item-kind]#external#

Allows SkaleManager to set a node's last bounty block.

[.contract-item]
[[Monitors-getCheckedArray-bytes32-]]
==== `++getCheckedArray(++[.var-type]#++bytes32++#++ ++[.var-name]#++monitorIndex++#++) → ++[.var-type]#++struct Monitors.CheckedNodeWithIp[]++#++ ++[.var-name]#++checkedNodesWithIp++#++++` [.item-kind]#external#

Returns node IPs that were last checked. TODO

[.contract-item]
[[Monitors-getLastBountyBlock-uint256-]]
==== `++getLastBountyBlock(++[.var-type]#++uint256++#++ ++[.var-name]#++nodeIndex++#++) → ++[.var-type]#++uint256++#++++` [.item-kind]#external#

Returns the latest blocknumber when node received bounty.

[.contract-item]
[[Monitors-getNodesInGroup-bytes32-]]
==== `++getNodesInGroup(++[.var-type]#++bytes32++#++ ++[.var-name]#++monitorIndex++#++) → ++[.var-type]#++uint256[]++#++++` [.item-kind]#external#

Returns the nodes in a monitoring group.

[.contract-item]
[[Monitors-getNumberOfNodesInGroup-bytes32-]]
==== `++getNumberOfNodesInGroup(++[.var-type]#++bytes32++#++ ++[.var-name]#++monitorIndex++#++) → ++[.var-type]#++uint256++#++++` [.item-kind]#external#

Returns the number of nodes in a monitoring group.

[.contract-item]
[[Monitors-initialize-address-]]
==== `++initialize(++[.var-type]#++address++#++ ++[.var-name]#++newContractsAddress++#++)++` [.item-kind]#public#



[.contract-item]
[[Monitors-addCheckedNode-bytes32-struct-Monitors-CheckedNode-]]
==== `++addCheckedNode(++[.var-type]#++bytes32++#++ ++[.var-name]#++monitorIndex++#++, ++[.var-type]#++struct Monitors.CheckedNode++#++ ++[.var-name]#++checkedNode++#++)++` [.item-kind]#public#

Allows SkaleManager to add checked node or update existing one if it is already exits

[.contract-item]
[[Monitors-getLastReceivedVerdictBlock-uint256-]]
==== `++getLastReceivedVerdictBlock(++[.var-type]#++uint256++#++ ++[.var-name]#++nodeIndex++#++) → ++[.var-type]#++uint256++#++++` [.item-kind]#public#

Returns the blocknumber when a node received its latest verdict.

[.contract-item]
[[Monitors-getLengthOfMetrics-bytes32-]]
==== `++getLengthOfMetrics(++[.var-type]#++bytes32++#++ ++[.var-name]#++monitorIndex++#++) → ++[.var-type]#++uint256++#++++` [.item-kind]#public#

Returns a count of metric data available for a node. TODO


[.contract-item]
[[Monitors-MonitorCreated-uint256-bytes32-uint256-uint256---uint256-uint256-]]
==== `++MonitorCreated(++[.var-type]#++uint256++#++ ++[.var-name]#++nodeIndex++#++, ++[.var-type]#++bytes32++#++ ++[.var-name]#++monitorIndex++#++, ++[.var-type]#++uint256++#++ ++[.var-name]#++numberOfMonitors++#++, ++[.var-type]#++uint256[]++#++ ++[.var-name]#++nodesInGroup++#++, ++[.var-type]#++uint256++#++ ++[.var-name]#++time++#++, ++[.var-type]#++uint256++#++ ++[.var-name]#++gasSpend++#++)++` [.item-kind]#event#

Emitted when a monitor group is created.

[.contract-item]
[[Monitors-VerdictWasSent-uint256-uint256-uint32-uint32-bool-uint256-uint256-uint256-]]
==== `++VerdictWasSent(++[.var-type]#++uint256++#++ ++[.var-name]#++fromMonitorIndex++#++, ++[.var-type]#++uint256++#++ ++[.var-name]#++toNodeIndex++#++, ++[.var-type]#++uint32++#++ ++[.var-name]#++downtime++#++, ++[.var-type]#++uint32++#++ ++[.var-name]#++latency++#++, ++[.var-type]#++bool++#++ ++[.var-name]#++status++#++, ++[.var-type]#++uint256++#++ ++[.var-name]#++previousBlockEvent++#++, ++[.var-type]#++uint256++#++ ++[.var-name]#++time++#++, ++[.var-type]#++uint256++#++ ++[.var-name]#++gasSpend++#++)++` [.item-kind]#event#

Emitted when a verdict is sent.

[.contract-item]
[[Monitors-MetricsWereCalculated-uint256-uint32-uint32-uint256-uint256-]]
==== `++MetricsWereCalculated(++[.var-type]#++uint256++#++ ++[.var-name]#++forNodeIndex++#++, ++[.var-type]#++uint32++#++ ++[.var-name]#++averageDowntime++#++, ++[.var-type]#++uint32++#++ ++[.var-name]#++averageLatency++#++, ++[.var-type]#++uint256++#++ ++[.var-name]#++time++#++, ++[.var-type]#++uint256++#++ ++[.var-name]#++gasSpend++#++)++` [.item-kind]#event#

Emitted when metrics are calculated.

[.contract-item]
[[Monitors-PeriodsWereSet-uint256-uint256-uint256-uint256-]]
==== `++PeriodsWereSet(++[.var-type]#++uint256++#++ ++[.var-name]#++rewardPeriod++#++, ++[.var-type]#++uint256++#++ ++[.var-name]#++deltaPeriod++#++, ++[.var-type]#++uint256++#++ ++[.var-name]#++time++#++, ++[.var-type]#++uint256++#++ ++[.var-name]#++gasSpend++#++)++` [.item-kind]#event#

Emitted when monitoring periods are set.

[.contract-item]
[[Monitors-MonitorRotated-bytes32-uint256-]]
==== `++MonitorRotated(++[.var-type]#++bytes32++#++ ++[.var-name]#++monitorIndex++#++, ++[.var-type]#++uint256++#++ ++[.var-name]#++newNode++#++)++` [.item-kind]#event#

Emitted when node rotation in a monitor group is performed.
