...
[.contract]
[[SchainsInternal]]
= SchainsInternal:SchainsInternal: pass:normal[xref:#SchainsInternal[`++SchainsInternal++`]]
...
==== `++createGroupForSchain(++[.var-type]#++bytes32++#++ ++[.var-name]#++schainId++#++, ++[.var-type]#++uint256++#++ ++[.var-name]#++numberOfNodes++#++, ++[.var-type]#++uint8++#++ ++[.var-name]#++partOfNode++#++) → ++[.var-type]#++uint256[]++#++++` [.item-kind]#external#
...
==== `++removeNodeFromSchain(++[.var-type]#++uint256++#++ ++[.var-name]#++nodeIndex++#++, ++[.var-type]#++bytes32++#++ ++[.var-name]#++schainHash++#++)++` [.item-kind]#external#
...
==== `++removeNodeFromExceptions(++[.var-type]#++bytes32++#++ ++[.var-name]#++schainHash++#++, ++[.var-type]#++uint256++#++ ++[.var-name]#++nodeIndex++#++)++` [.item-kind]#external#



[.contract-item]
[[SchainsInternal-deleteGroup-bytes32-]]
==== `++deleteGroup(++[.var-type]#++bytes32++#++ ++[.var-name]#++schainId++#++)++` [.item-kind]#external#

Allows Schains contract to delete a group of schains

[.contract-item]
[[SchainsInternal-setException-bytes32-uint256-]]
==== `++setException(++[.var-type]#++bytes32++#++ ++[.var-name]#++schainId++#++, ++[.var-type]#++uint256++#++ ++[.var-name]#++nodeIndex++#++)++` [.item-kind]#external#
...
==== `++setNodeInGroup(++[.var-type]#++bytes32++#++ ++[.var-name]#++schainId++#++, ++[.var-type]#++uint256++#++ ++[.var-name]#++nodeIndex++#++)++` [.item-kind]#external#

Allows Schains contract to add node to an schain group.

[.contract-item]
[[SchainsInternal-removeHolesForSchain-bytes32-]]
==== `++removeHolesForSchain(++[.var-type]#++bytes32++#++ ++[.var-name]#++schainHash++#++)++` [.item-kind]#external#
...
==== `++getNumberOfNodesInGroup(++[.var-type]#++bytes32++#++ ++[.var-name]#++schainId++#++) → ++[.var-type]#++uint256++#++++` [.item-kind]#external#
...
==== `++getNodeIndexInGroup(++[.var-type]#++bytes32++#++ ++[.var-name]#++schainId++#++, ++[.var-type]#++uint256++#++ ++[.var-name]#++nodeId++#++) → ++[.var-type]#++uint256++#++++` [.item-kind]#external#

Returns node index in schain group.

[.contract-item]
[[SchainsInternal-isAnyFreeNode-bytes32-]]
==== `++isAnyFreeNode(++[.var-type]#++bytes32++#++ ++[.var-name]#++schainId++#++) → ++[.var-type]#++bool++#++++` [.item-kind]#external#



[.contract-item]
[[SchainsInternal-checkException-bytes32-uint256-]]
==== `++checkException(++[.var-type]#++bytes32++#++ ++[.var-name]#++schainId++#++, ++[.var-type]#++uint256++#++ ++[.var-name]#++nodeIndex++#++) → ++[.var-type]#++bool++#++++` [.item-kind]#external#



[.contract-item]
[[SchainsInternal-checkHoleForSchain-bytes32-uint256-]]
==== `++checkHoleForSchain(++[.var-type]#++bytes32++#++ ++[.var-name]#++schainHash++#++, ++[.var-type]#++uint256++#++ ++[.var-name]#++indexOfNode++#++) → ++[.var-type]#++bool++#++++` [.item-kind]#external#
...
==== `++addSchainForNode(++[.var-type]#++uint256++#++ ++[.var-name]#++nodeIndex++#++, ++[.var-type]#++bytes32++#++ ++[.var-name]#++schainId++#++)++` [.item-kind]#public#

Allows Schain contract to add schain to node.

[.contract-item]
[[SchainsInternal-removeSchainForNode-uint256-uint256-]]
==== `++removeSchainForNode(++[.var-type]#++uint256++#++ ++[.var-name]#++nodeIndex++#++, ++[.var-type]#++uint256++#++ ++[.var-name]#++schainIndex++#++)++` [.item-kind]#public#
...
==== `++getLengthOfSchainsForNode(++[.var-type]#++uint256++#++ ++[.var-name]#++nodeIndex++#++) → ++[.var-type]#++uint256++#++++` [.item-kind]#public#
...
==== `++isEnoughNodes(++[.var-type]#++bytes32++#++ ++[.var-name]#++schainId++#++) → ++[.var-type]#++uint256[]++#++ ++[.var-name]#++result++#++++` [.item-kind]#public#
