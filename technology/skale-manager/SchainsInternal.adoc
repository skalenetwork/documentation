:Bounty: pass:normal[xref:bounty.adoc#Bounty[`Bounty`]]
...
:SchainsInternal: pass:normal[xref:#SchainsInternal[`++SchainsInternal++`]]
:schains: pass:normal[xref:#SchainsInternal-schains-mapping-bytes32----struct-SchainsInternal-Schain-[`++schains++`]]
:isSchainActive: pass:normal[xref:#SchainsInternal-isSchainActive-mapping-bytes32----bool-[`++isSchainActive++`]]
:schainsGroups: pass:normal[xref:#SchainsInternal-schainsGroups-mapping-bytes32----uint256---[`++schainsGroups++`]]
:schainIndexes: pass:normal[xref:#SchainsInternal-schainIndexes-mapping-address----bytes32---[`++schainIndexes++`]]
:schainsForNodes: pass:normal[xref:#SchainsInternal-schainsForNodes-mapping-uint256----bytes32---[`++schainsForNodes++`]]
:holesForNodes: pass:normal[xref:#SchainsInternal-holesForNodes-mapping-uint256----uint256---[`++holesForNodes++`]]
:holesForSchains: pass:normal[xref:#SchainsInternal-holesForSchains-mapping-bytes32----uint256---[`++holesForSchains++`]]
:schainsAtSystem: pass:normal[xref:#SchainsInternal-schainsAtSystem-bytes32--[`++schainsAtSystem++`]]
:numberOfSchains: pass:normal[xref:#SchainsInternal-numberOfSchains-uint64[`++numberOfSchains++`]]
:sumOfSchainsResources: pass:normal[xref:#SchainsInternal-sumOfSchainsResources-uint256[`++sumOfSchainsResources++`]]
:initializeSchain: pass:normal[xref:#SchainsInternal-initializeSchain-string-address-uint256-uint256-[`++initializeSchain++`]]
:createGroupForSchain: pass:normal[xref:#SchainsInternal-createGroupForSchain-bytes32-uint256-uint8-[`++createGroupForSchain++`]]
:setSchainIndex: pass:normal[xref:#SchainsInternal-setSchainIndex-bytes32-address-[`++setSchainIndex++`]]
:changeLifetime: pass:normal[xref:#SchainsInternal-changeLifetime-bytes32-uint256-uint256-[`++changeLifetime++`]]
:removeSchain: pass:normal[xref:#SchainsInternal-removeSchain-bytes32-address-[`++removeSchain++`]]
:removeNodeFromSchain: pass:normal[xref:#SchainsInternal-removeNodeFromSchain-uint256-bytes32-[`++removeNodeFromSchain++`]]
:removeNodeFromExceptions: pass:normal[xref:#SchainsInternal-removeNodeFromExceptions-bytes32-uint256-[`++removeNodeFromExceptions++`]]
:deleteGroup: pass:normal[xref:#SchainsInternal-deleteGroup-bytes32-[`++deleteGroup++`]]
:setException: pass:normal[xref:#SchainsInternal-setException-bytes32-uint256-[`++setException++`]]
:setNodeInGroup: pass:normal[xref:#SchainsInternal-setNodeInGroup-bytes32-uint256-[`++setNodeInGroup++`]]
:removeHolesForSchain: pass:normal[xref:#SchainsInternal-removeHolesForSchain-bytes32-[`++removeHolesForSchain++`]]
:getSchains: pass:normal[xref:#SchainsInternal-getSchains--[`++getSchains++`]]
:getSchainsPartOfNode: pass:normal[xref:#SchainsInternal-getSchainsPartOfNode-bytes32-[`++getSchainsPartOfNode++`]]
:getSchainListSize: pass:normal[xref:#SchainsInternal-getSchainListSize-address-[`++getSchainListSize++`]]
:getSchainIdsByAddress: pass:normal[xref:#SchainsInternal-getSchainIdsByAddress-address-[`++getSchainIdsByAddress++`]]
:getSchainIdsForNode: pass:normal[xref:#SchainsInternal-getSchainIdsForNode-uint256-[`++getSchainIdsForNode++`]]
:getSchainOwner: pass:normal[xref:#SchainsInternal-getSchainOwner-bytes32-[`++getSchainOwner++`]]
:isSchainNameAvailable: pass:normal[xref:#SchainsInternal-isSchainNameAvailable-string-[`++isSchainNameAvailable++`]]
:isTimeExpired: pass:normal[xref:#SchainsInternal-isTimeExpired-bytes32-[`++isTimeExpired++`]]
:isOwnerAddress: pass:normal[xref:#SchainsInternal-isOwnerAddress-address-bytes32-[`++isOwnerAddress++`]]
:isSchainExist: pass:normal[xref:#SchainsInternal-isSchainExist-bytes32-[`++isSchainExist++`]]
:getSchainName: pass:normal[xref:#SchainsInternal-getSchainName-bytes32-[`++getSchainName++`]]
:getActiveSchain: pass:normal[xref:#SchainsInternal-getActiveSchain-uint256-[`++getActiveSchain++`]]
:getActiveSchains: pass:normal[xref:#SchainsInternal-getActiveSchains-uint256-[`++getActiveSchains++`]]
:getNumberOfNodesInGroup: pass:normal[xref:#SchainsInternal-getNumberOfNodesInGroup-bytes32-[`++getNumberOfNodesInGroup++`]]
:getNodesInGroup: pass:normal[xref:#SchainsInternal-getNodesInGroup-bytes32-[`++getNodesInGroup++`]]
:getNodeIndexInGroup: pass:normal[xref:#SchainsInternal-getNodeIndexInGroup-bytes32-uint256-[`++getNodeIndexInGroup++`]]
:isAnyFreeNode: pass:normal[xref:#SchainsInternal-isAnyFreeNode-bytes32-[`++isAnyFreeNode++`]]
:checkException: pass:normal[xref:#SchainsInternal-checkException-bytes32-uint256-[`++checkException++`]]
:checkHoleForSchain: pass:normal[xref:#SchainsInternal-checkHoleForSchain-bytes32-uint256-[`++checkHoleForSchain++`]]
:initialize: pass:normal[xref:#SchainsInternal-initialize-address-[`++initialize++`]]
:addSchainForNode: pass:normal[xref:#SchainsInternal-addSchainForNode-uint256-bytes32-[`++addSchainForNode++`]]
:removeSchainForNode: pass:normal[xref:#SchainsInternal-removeSchainForNode-uint256-uint256-[`++removeSchainForNode++`]]
:getLengthOfSchainsForNode: pass:normal[xref:#SchainsInternal-getLengthOfSchainsForNode-uint256-[`++getLengthOfSchainsForNode++`]]
:findSchainAtSchainsForNode: pass:normal[xref:#SchainsInternal-findSchainAtSchainsForNode-uint256-bytes32-[`++findSchainAtSchainsForNode++`]]
:isEnoughNodes: pass:normal[xref:#SchainsInternal-isEnoughNodes-bytes32-[`++isEnoughNodes++`]]
...
.Functions
--
* {xref-SchainsInternal-initializeSchain-string-address-uint256-uint256-}[`++initializeSchain(name, from, lifetime, deposit)++`]
* {xref-SchainsInternal-createGroupForSchain-bytes32-uint256-uint8-}[`++createGroupForSchain(schainId, numberOfNodes, partOfNode)++`]
* {xref-SchainsInternal-setSchainIndex-bytes32-address-}[`++setSchainIndex(schainId, from)++`]
* {xref-SchainsInternal-changeLifetime-bytes32-uint256-uint256-}[`++changeLifetime(schainId, lifetime, deposit)++`]
* {xref-SchainsInternal-removeSchain-bytes32-address-}[`++removeSchain(schainId, from)++`]
* {xref-SchainsInternal-removeNodeFromSchain-uint256-bytes32-}[`++removeNodeFromSchain(nodeIndex, schainHash)++`]
* {xref-SchainsInternal-removeNodeFromExceptions-bytes32-uint256-}[`++removeNodeFromExceptions(schainHash, nodeIndex)++`]
* {xref-SchainsInternal-deleteGroup-bytes32-}[`++deleteGroup(schainId)++`]
* {xref-SchainsInternal-setException-bytes32-uint256-}[`++setException(schainId, nodeIndex)++`]
* {xref-SchainsInternal-setNodeInGroup-bytes32-uint256-}[`++setNodeInGroup(schainId, nodeIndex)++`]
* {xref-SchainsInternal-removeHolesForSchain-bytes32-}[`++removeHolesForSchain(schainHash)++`]
* {xref-SchainsInternal-getSchains--}[`++getSchains()++`]
* {xref-SchainsInternal-getSchainsPartOfNode-bytes32-}[`++getSchainsPartOfNode(schainId)++`]
* {xref-SchainsInternal-getSchainListSize-address-}[`++getSchainListSize(from)++`]
* {xref-SchainsInternal-getSchainIdsByAddress-address-}[`++getSchainIdsByAddress(from)++`]
* {xref-SchainsInternal-getSchainIdsForNode-uint256-}[`++getSchainIdsForNode(nodeIndex)++`]
* {xref-SchainsInternal-getSchainOwner-bytes32-}[`++getSchainOwner(schainId)++`]
* {xref-SchainsInternal-isSchainNameAvailable-string-}[`++isSchainNameAvailable(name)++`]
* {xref-SchainsInternal-isTimeExpired-bytes32-}[`++isTimeExpired(schainId)++`]
* {xref-SchainsInternal-isOwnerAddress-address-bytes32-}[`++isOwnerAddress(from, schainId)++`]
* {xref-SchainsInternal-isSchainExist-bytes32-}[`++isSchainExist(schainId)++`]
* {xref-SchainsInternal-getSchainName-bytes32-}[`++getSchainName(schainId)++`]
* {xref-SchainsInternal-getActiveSchain-uint256-}[`++getActiveSchain(nodeIndex)++`]
* {xref-SchainsInternal-getActiveSchains-uint256-}[`++getActiveSchains(nodeIndex)++`]
* {xref-SchainsInternal-getNumberOfNodesInGroup-bytes32-}[`++getNumberOfNodesInGroup(schainId)++`]
* {xref-SchainsInternal-getNodesInGroup-bytes32-}[`++getNodesInGroup(schainId)++`]
* {xref-SchainsInternal-getNodeIndexInGroup-bytes32-uint256-}[`++getNodeIndexInGroup(schainId, nodeId)++`]
* {xref-SchainsInternal-isAnyFreeNode-bytes32-}[`++isAnyFreeNode(schainId)++`]
* {xref-SchainsInternal-checkException-bytes32-uint256-}[`++checkException(schainId, nodeIndex)++`]
* {xref-SchainsInternal-checkHoleForSchain-bytes32-uint256-}[`++checkHoleForSchain(schainHash, indexOfNode)++`]
* {xref-SchainsInternal-initialize-address-}[`++initialize(newContractsAddress)++`]
* {xref-SchainsInternal-addSchainForNode-uint256-bytes32-}[`++addSchainForNode(nodeIndex, schainId)++`]
* {xref-SchainsInternal-removeSchainForNode-uint256-uint256-}[`++removeSchainForNode(nodeIndex, schainIndex)++`]
* {xref-SchainsInternal-getLengthOfSchainsForNode-uint256-}[`++getLengthOfSchainsForNode(nodeIndex)++`]
* {xref-SchainsInternal-findSchainAtSchainsForNode-uint256-bytes32-}[`++findSchainAtSchainsForNode(nodeIndex, schainId)++`]
* {xref-SchainsInternal-isEnoughNodes-bytes32-}[`++isEnoughNodes(schainId)++`]
--
...
[.contract-item]
[[SchainsInternal-initializeSchain-string-address-uint256-uint256-]]
==== +++<a class="heading-anchor" area-hidden="true" name=SchainsInternal-initializeSchain-string-address-uint256-uint256->initializeSchain</a>+++ `++initializeSchain(++[.var-type]#++string++#++ ++[.var-name]#++name++#++, ++[.var-type]#++address++#++ ++[.var-name]#++from++#++, ++[.var-type]#++uint256++#++ ++[.var-name]#++lifetime++#++, ++[.var-type]#++uint256++#++ ++[.var-name]#++deposit++#++)++` [.item-kind]#external#

Allows Schain contract to initialize an schain.

[.contract-item]
[[SchainsInternal-createGroupForSchain-bytes32-uint256-uint8-]]
==== +++<a class="heading-anchor" area-hidden="true" name=SchainsInternal-createGroupForSchain-bytes32-uint256-uint8->createGroupForSchain</a>+++ `++createGroupForSchain(++[.var-type]#++bytes32++#++ ++[.var-name]#++schainId++#++, ++[.var-type]#++uint256++#++ ++[.var-name]#++numberOfNodes++#++, ++[.var-type]#++uint8++#++ ++[.var-name]#++partOfNode++#++) → ++[.var-type]#++uint256[]++#++++` [.item-kind]#external#

Allows Schain contract to create a node group for an schain.

[.contract-item]
[[SchainsInternal-setSchainIndex-bytes32-address-]]
==== +++<a class="heading-anchor" area-hidden="true" name=SchainsInternal-setSchainIndex-bytes32-address->setSchainIndex</a>+++ `++setSchainIndex(++[.var-type]#++bytes32++#++ ++[.var-name]#++schainId++#++, ++[.var-type]#++address++#++ ++[.var-name]#++from++#++)++` [.item-kind]#external#

Allows Schains contract to set schain index.

[.contract-item]
[[SchainsInternal-changeLifetime-bytes32-uint256-uint256-]]
==== +++<a class="heading-anchor" area-hidden="true" name=SchainsInternal-changeLifetime-bytes32-uint256-uint256->changeLifetime</a>+++ `++changeLifetime(++[.var-type]#++bytes32++#++ ++[.var-name]#++schainId++#++, ++[.var-type]#++uint256++#++ ++[.var-name]#++lifetime++#++, ++[.var-type]#++uint256++#++ ++[.var-name]#++deposit++#++)++` [.item-kind]#external#

Allows Schains contract to change the Schain lifetime through
an additional SKL token deposit.

[.contract-item]
[[SchainsInternal-removeSchain-bytes32-address-]]
==== +++<a class="heading-anchor" area-hidden="true" name=SchainsInternal-removeSchain-bytes32-address->removeSchain</a>+++ `++removeSchain(++[.var-type]#++bytes32++#++ ++[.var-name]#++schainId++#++, ++[.var-type]#++address++#++ ++[.var-name]#++from++#++)++` [.item-kind]#external#

Allows Schains contract to remove an schain from the network.
Generally schains are not removed from the system; instead they are
simply allowed to expire.

[.contract-item]
[[SchainsInternal-removeNodeFromSchain-uint256-bytes32-]]
==== +++<a class="heading-anchor" area-hidden="true" name=SchainsInternal-removeNodeFromSchain-uint256-bytes32->removeNodeFromSchain</a>+++ `++removeNodeFromSchain(++[.var-type]#++uint256++#++ ++[.var-name]#++nodeIndex++#++, ++[.var-type]#++bytes32++#++ ++[.var-name]#++schainHash++#++)++` [.item-kind]#external#

Allows Schains and SkaleDKG contracts to remove a node from an
schain for node rotation or DKG failure.

[.contract-item]
[[SchainsInternal-removeNodeFromExceptions-bytes32-uint256-]]
==== +++<a class="heading-anchor" area-hidden="true" name=SchainsInternal-removeNodeFromExceptions-bytes32-uint256->removeNodeFromExceptions</a>+++ `++removeNodeFromExceptions(++[.var-type]#++bytes32++#++ ++[.var-name]#++schainHash++#++, ++[.var-type]#++uint256++#++ ++[.var-name]#++nodeIndex++#++)++` [.item-kind]#external#



[.contract-item]
[[SchainsInternal-deleteGroup-bytes32-]]
==== +++<a class="heading-anchor" area-hidden="true" name=SchainsInternal-deleteGroup-bytes32->deleteGroup</a>+++ `++deleteGroup(++[.var-type]#++bytes32++#++ ++[.var-name]#++schainId++#++)++` [.item-kind]#external#

Allows Schains contract to delete a group of schains

[.contract-item]
[[SchainsInternal-setException-bytes32-uint256-]]
==== +++<a class="heading-anchor" area-hidden="true" name=SchainsInternal-setException-bytes32-uint256->setException</a>+++ `++setException(++[.var-type]#++bytes32++#++ ++[.var-name]#++schainId++#++, ++[.var-type]#++uint256++#++ ++[.var-name]#++nodeIndex++#++)++` [.item-kind]#external#

Allows Schain contract to set a Node like exception for a given
schain and nodeIndex.

[.contract-item]
[[SchainsInternal-setNodeInGroup-bytes32-uint256-]]
==== +++<a class="heading-anchor" area-hidden="true" name=SchainsInternal-setNodeInGroup-bytes32-uint256->setNodeInGroup</a>+++ `++setNodeInGroup(++[.var-type]#++bytes32++#++ ++[.var-name]#++schainId++#++, ++[.var-type]#++uint256++#++ ++[.var-name]#++nodeIndex++#++)++` [.item-kind]#external#

Allows Schains contract to add node to an schain group.

[.contract-item]
[[SchainsInternal-removeHolesForSchain-bytes32-]]
==== +++<a class="heading-anchor" area-hidden="true" name=SchainsInternal-removeHolesForSchain-bytes32->removeHolesForSchain</a>+++ `++removeHolesForSchain(++[.var-type]#++bytes32++#++ ++[.var-name]#++schainHash++#++)++` [.item-kind]#external#



[.contract-item]
[[SchainsInternal-getSchains--]]
==== +++<a class="heading-anchor" area-hidden="true" name=SchainsInternal-getSchains-->getSchains</a>+++ `++getSchains() → ++[.var-type]#++bytes32[]++#++++` [.item-kind]#external#

Returns all Schains in the network.

[.contract-item]
[[SchainsInternal-getSchainsPartOfNode-bytes32-]]
==== +++<a class="heading-anchor" area-hidden="true" name=SchainsInternal-getSchainsPartOfNode-bytes32->getSchainsPartOfNode</a>+++ `++getSchainsPartOfNode(++[.var-type]#++bytes32++#++ ++[.var-name]#++schainId++#++) → ++[.var-type]#++uint8++#++++` [.item-kind]#external#

Returns all occupied resources for an Schain

[.contract-item]
[[SchainsInternal-getSchainListSize-address-]]
==== +++<a class="heading-anchor" area-hidden="true" name=SchainsInternal-getSchainListSize-address->getSchainListSize</a>+++ `++getSchainListSize(++[.var-type]#++address++#++ ++[.var-name]#++from++#++) → ++[.var-type]#++uint256++#++++` [.item-kind]#external#

Returns number of schains by schain owner.

[.contract-item]
[[SchainsInternal-getSchainIdsByAddress-address-]]
==== +++<a class="heading-anchor" area-hidden="true" name=SchainsInternal-getSchainIdsByAddress-address->getSchainIdsByAddress</a>+++ `++getSchainIdsByAddress(++[.var-type]#++address++#++ ++[.var-name]#++from++#++) → ++[.var-type]#++bytes32[]++#++++` [.item-kind]#external#

Returns hashes of schain names by schain owner.

[.contract-item]
[[SchainsInternal-getSchainIdsForNode-uint256-]]
==== +++<a class="heading-anchor" area-hidden="true" name=SchainsInternal-getSchainIdsForNode-uint256->getSchainIdsForNode</a>+++ `++getSchainIdsForNode(++[.var-type]#++uint256++#++ ++[.var-name]#++nodeIndex++#++) → ++[.var-type]#++bytes32[]++#++++` [.item-kind]#external#

Returns hashes of schain names running on a node.

[.contract-item]
[[SchainsInternal-getSchainOwner-bytes32-]]
==== +++<a class="heading-anchor" area-hidden="true" name=SchainsInternal-getSchainOwner-bytes32->getSchainOwner</a>+++ `++getSchainOwner(++[.var-type]#++bytes32++#++ ++[.var-name]#++schainId++#++) → ++[.var-type]#++address++#++++` [.item-kind]#external#

Returns the owner of an schain.

[.contract-item]
[[SchainsInternal-isSchainNameAvailable-string-]]
==== +++<a class="heading-anchor" area-hidden="true" name=SchainsInternal-isSchainNameAvailable-string->isSchainNameAvailable</a>+++ `++isSchainNameAvailable(++[.var-type]#++string++#++ ++[.var-name]#++name++#++) → ++[.var-type]#++bool++#++++` [.item-kind]#external#

Checks whether schain name is available.
TODO Need to delete - copy of web3.utils.soliditySha3

[.contract-item]
[[SchainsInternal-isTimeExpired-bytes32-]]
==== +++<a class="heading-anchor" area-hidden="true" name=SchainsInternal-isTimeExpired-bytes32->isTimeExpired</a>+++ `++isTimeExpired(++[.var-type]#++bytes32++#++ ++[.var-name]#++schainId++#++) → ++[.var-type]#++bool++#++++` [.item-kind]#external#

Checks whether schain lifetime has expired.

[.contract-item]
[[SchainsInternal-isOwnerAddress-address-bytes32-]]
==== +++<a class="heading-anchor" area-hidden="true" name=SchainsInternal-isOwnerAddress-address-bytes32->isOwnerAddress</a>+++ `++isOwnerAddress(++[.var-type]#++address++#++ ++[.var-name]#++from++#++, ++[.var-type]#++bytes32++#++ ++[.var-name]#++schainId++#++) → ++[.var-type]#++bool++#++++` [.item-kind]#external#

Checks whether address is owner of schain.

[.contract-item]
[[SchainsInternal-isSchainExist-bytes32-]]
==== +++<a class="heading-anchor" area-hidden="true" name=SchainsInternal-isSchainExist-bytes32->isSchainExist</a>+++ `++isSchainExist(++[.var-type]#++bytes32++#++ ++[.var-name]#++schainId++#++) → ++[.var-type]#++bool++#++++` [.item-kind]#external#

Checks whether schain exists.

[.contract-item]
[[SchainsInternal-getSchainName-bytes32-]]
==== +++<a class="heading-anchor" area-hidden="true" name=SchainsInternal-getSchainName-bytes32->getSchainName</a>+++ `++getSchainName(++[.var-type]#++bytes32++#++ ++[.var-name]#++schainId++#++) → ++[.var-type]#++string++#++++` [.item-kind]#external#

Returns schain name.

[.contract-item]
[[SchainsInternal-getActiveSchain-uint256-]]
==== +++<a class="heading-anchor" area-hidden="true" name=SchainsInternal-getActiveSchain-uint256->getActiveSchain</a>+++ `++getActiveSchain(++[.var-type]#++uint256++#++ ++[.var-name]#++nodeIndex++#++) → ++[.var-type]#++bytes32++#++++` [.item-kind]#external#

Returns active schains of a node. TODO: confirm

[.contract-item]
[[SchainsInternal-getActiveSchains-uint256-]]
==== +++<a class="heading-anchor" area-hidden="true" name=SchainsInternal-getActiveSchains-uint256->getActiveSchains</a>+++ `++getActiveSchains(++[.var-type]#++uint256++#++ ++[.var-name]#++nodeIndex++#++) → ++[.var-type]#++bytes32[]++#++ ++[.var-name]#++activeSchains++#++++` [.item-kind]#external#

Returns active schains of a node. TODO: confirm

[.contract-item]
[[SchainsInternal-getNumberOfNodesInGroup-bytes32-]]
==== +++<a class="heading-anchor" area-hidden="true" name=SchainsInternal-getNumberOfNodesInGroup-bytes32->getNumberOfNodesInGroup</a>+++ `++getNumberOfNodesInGroup(++[.var-type]#++bytes32++#++ ++[.var-name]#++schainId++#++) → ++[.var-type]#++uint256++#++++` [.item-kind]#external#

Returns number of nodes in an schain group.

[.contract-item]
[[SchainsInternal-getNodesInGroup-bytes32-]]
==== +++<a class="heading-anchor" area-hidden="true" name=SchainsInternal-getNodesInGroup-bytes32->getNodesInGroup</a>+++ `++getNodesInGroup(++[.var-type]#++bytes32++#++ ++[.var-name]#++schainId++#++) → ++[.var-type]#++uint256[]++#++++` [.item-kind]#external#

Returns nodes in an schain group.

[.contract-item]
[[SchainsInternal-getNodeIndexInGroup-bytes32-uint256-]]
==== +++<a class="heading-anchor" area-hidden="true" name=SchainsInternal-getNodeIndexInGroup-bytes32-uint256->getNodeIndexInGroup</a>+++ `++getNodeIndexInGroup(++[.var-type]#++bytes32++#++ ++[.var-name]#++schainId++#++, ++[.var-type]#++uint256++#++ ++[.var-name]#++nodeId++#++) → ++[.var-type]#++uint256++#++++` [.item-kind]#external#

Returns node index in schain group.

[.contract-item]
[[SchainsInternal-isAnyFreeNode-bytes32-]]
==== +++<a class="heading-anchor" area-hidden="true" name=SchainsInternal-isAnyFreeNode-bytes32->isAnyFreeNode</a>+++ `++isAnyFreeNode(++[.var-type]#++bytes32++#++ ++[.var-name]#++schainId++#++) → ++[.var-type]#++bool++#++++` [.item-kind]#external#



[.contract-item]
[[SchainsInternal-checkException-bytes32-uint256-]]
==== +++<a class="heading-anchor" area-hidden="true" name=SchainsInternal-checkException-bytes32-uint256->checkException</a>+++ `++checkException(++[.var-type]#++bytes32++#++ ++[.var-name]#++schainId++#++, ++[.var-type]#++uint256++#++ ++[.var-name]#++nodeIndex++#++) → ++[.var-type]#++bool++#++++` [.item-kind]#external#



[.contract-item]
[[SchainsInternal-checkHoleForSchain-bytes32-uint256-]]
==== +++<a class="heading-anchor" area-hidden="true" name=SchainsInternal-checkHoleForSchain-bytes32-uint256->checkHoleForSchain</a>+++ `++checkHoleForSchain(++[.var-type]#++bytes32++#++ ++[.var-name]#++schainHash++#++, ++[.var-type]#++uint256++#++ ++[.var-name]#++indexOfNode++#++) → ++[.var-type]#++bool++#++++` [.item-kind]#external#



[.contract-item]
[[SchainsInternal-initialize-address-]]
==== +++<a class="heading-anchor" area-hidden="true" name=SchainsInternal-initialize-address->initialize</a>+++ `++initialize(++[.var-type]#++address++#++ ++[.var-name]#++newContractsAddress++#++)++` [.item-kind]#public#



[.contract-item]
[[SchainsInternal-addSchainForNode-uint256-bytes32-]]
==== +++<a class="heading-anchor" area-hidden="true" name=SchainsInternal-addSchainForNode-uint256-bytes32->addSchainForNode</a>+++ `++addSchainForNode(++[.var-type]#++uint256++#++ ++[.var-name]#++nodeIndex++#++, ++[.var-type]#++bytes32++#++ ++[.var-name]#++schainId++#++)++` [.item-kind]#public#

Allows Schain contract to add schain to node.

[.contract-item]
[[SchainsInternal-removeSchainForNode-uint256-uint256-]]
==== +++<a class="heading-anchor" area-hidden="true" name=SchainsInternal-removeSchainForNode-uint256-uint256->removeSchainForNode</a>+++ `++removeSchainForNode(++[.var-type]#++uint256++#++ ++[.var-name]#++nodeIndex++#++, ++[.var-type]#++uint256++#++ ++[.var-name]#++schainIndex++#++)++` [.item-kind]#public#

Allows Schains and SkaleDKG contracts to remove an schain from a
node.

[.contract-item]
[[SchainsInternal-getLengthOfSchainsForNode-uint256-]]
==== +++<a class="heading-anchor" area-hidden="true" name=SchainsInternal-getLengthOfSchainsForNode-uint256->getLengthOfSchainsForNode</a>+++ `++getLengthOfSchainsForNode(++[.var-type]#++uint256++#++ ++[.var-name]#++nodeIndex++#++) → ++[.var-type]#++uint256++#++++` [.item-kind]#public#

Returns number of Schains on a node.

[.contract-item]
[[SchainsInternal-findSchainAtSchainsForNode-uint256-bytes32-]]
==== +++<a class="heading-anchor" area-hidden="true" name=SchainsInternal-findSchainAtSchainsForNode-uint256-bytes32->findSchainAtSchainsForNode</a>+++ `++findSchainAtSchainsForNode(++[.var-type]#++uint256++#++ ++[.var-name]#++nodeIndex++#++, ++[.var-type]#++bytes32++#++ ++[.var-name]#++schainId++#++) → ++[.var-type]#++uint256++#++++` [.item-kind]#public#

Returns index of Schain in schainsForNode array. TODO: confirm

[.contract-item]
[[SchainsInternal-isEnoughNodes-bytes32-]]
==== +++<a class="heading-anchor" area-hidden="true" name=SchainsInternal-isEnoughNodes-bytes32->isEnoughNodes</a>+++ `++isEnoughNodes(++[.var-type]#++bytes32++#++ ++[.var-name]#++schainId++#++) → ++[.var-type]#++uint256[]++#++ ++[.var-name]#++result++#++++` [.item-kind]#public#
