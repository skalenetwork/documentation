...
:Schains: pass:normal[xref:#Schains[`++Schains++`]]
:SCHAIN_CREATOR_ROLE: pass:normal[xref:#Schains-SCHAIN_CREATOR_ROLE-bytes32[`++SCHAIN_CREATOR_ROLE++`]]
:addSchain: pass:normal[xref:#Schains-addSchain-address-uint256-bytes-[`++addSchain++`]]
:addSchainByFoundation: pass:normal[xref:#Schains-addSchainByFoundation-uint256-uint8-uint16-string-[`++addSchainByFoundation++`]]
:deleteSchain: pass:normal[xref:#Schains-deleteSchain-address-string-[`++deleteSchain++`]]
:deleteSchainByRoot: pass:normal[xref:#Schains-deleteSchainByRoot-string-[`++deleteSchainByRoot++`]]
:restartSchainCreation: pass:normal[xref:#Schains-restartSchainCreation-string-[`++restartSchainCreation++`]]
:verifySchainSignature: pass:normal[xref:#Schains-verifySchainSignature-uint256-uint256-bytes32-uint256-uint256-uint256-string-[`++verifySchainSignature++`]]
:initialize: pass:normal[xref:#Schains-initialize-address-[`++initialize++`]]
:getSchainPrice: pass:normal[xref:#Schains-getSchainPrice-uint256-uint256-[`++getSchainPrice++`]]
:getNodesDataFromTypeOfSchain: pass:normal[xref:#Schains-getNodesDataFromTypeOfSchain-uint256-[`++getNodesDataFromTypeOfSchain++`]]
:SchainCreated: pass:normal[xref:#Schains-SchainCreated-string-address-uint256-uint256-uint256-uint256-uint16-bytes32-uint256-uint256-[`++SchainCreated++`]]
:SchainDeleted: pass:normal[xref:#Schains-SchainDeleted-address-string-bytes32-[`++SchainDeleted++`]]
:NodeRotated: pass:normal[xref:#Schains-NodeRotated-bytes32-uint256-uint256-[`++NodeRotated++`]]
:NodeAdded: pass:normal[xref:#Schains-NodeAdded-bytes32-uint256-[`++NodeAdded++`]]
:SchainNodes: pass:normal[xref:#Schains-SchainNodes-string-bytes32-uint256---uint256-uint256-[`++SchainNodes++`]]

[.contract]
[[Schains]]
=== `++Schains++`

Contains functions to manage Schains such as Schain creation,
...
.Functions
--
* {xref-Schains-addSchain-address-uint256-bytes-}[`++addSchain(from, deposit, data)++`]
* {xref-Schains-addSchainByFoundation-uint256-uint8-uint16-string-}[`++addSchainByFoundation(lifetime, typeOfSchain, nonce, name)++`]
* {xref-Schains-deleteSchain-address-string-}[`++deleteSchain(from, name)++`]
* {xref-Schains-deleteSchainByRoot-string-}[`++deleteSchainByRoot(name)++`]
* {xref-Schains-restartSchainCreation-string-}[`++restartSchainCreation(name)++`]
* {xref-Schains-verifySchainSignature-uint256-uint256-bytes32-uint256-uint256-uint256-string-}[`++verifySchainSignature(signatureA, signatureB, hash, counter, hashA, hashB, schainName)++`]
* {xref-Schains-initialize-address-}[`++initialize(newContractsAddress)++`]
* {xref-Schains-getSchainPrice-uint256-uint256-}[`++getSchainPrice(typeOfSchain, lifetime)++`]
* {xref-Schains-getNodesDataFromTypeOfSchain-uint256-}[`++getNodesDataFromTypeOfSchain(typeOfSchain)++`]
...
.Events
--
* {xref-Schains-SchainCreated-string-address-uint256-uint256-uint256-uint256-uint16-bytes32-uint256-uint256-}[`++SchainCreated(name, owner, partOfNode, lifetime, numberOfNodes, deposit, nonce, schainId, time, gasSpend)++`]
* {xref-Schains-SchainDeleted-address-string-bytes32-}[`++SchainDeleted(owner, name, schainId)++`]
* {xref-Schains-NodeRotated-bytes32-uint256-uint256-}[`++NodeRotated(schainId, oldNode, newNode)++`]
* {xref-Schains-NodeAdded-bytes32-uint256-}[`++NodeAdded(schainId, newNode)++`]
* {xref-Schains-SchainNodes-string-bytes32-uint256---uint256-uint256-}[`++SchainNodes(name, schainId, nodesInGroup, time, gasSpend)++`]
...
[.contract-item]
[[Schains-addSchain-address-uint256-bytes-]]
...
[.contract-item]
[[Schains-addSchainByFoundation-uint256-uint8-uint16-string-]]
==== `++addSchainByFoundation(++[.var-type]#++uint256++#++ ++[.var-name]#++lifetime++#++, ++[.var-type]#++uint8++#++ ++[.var-name]#++typeOfSchain++#++, ++[.var-type]#++uint16++#++ ++[.var-name]#++nonce++#++, ++[.var-type]#++string++#++ ++[.var-name]#++name++#++)++` [.item-kind]#external#



[.contract-item]
[[Schains-deleteSchain-address-string-]]
==== `++deleteSchain(++[.var-type]#++address++#++ ++[.var-name]#++from++#++, ++[.var-type]#++string++#++ ++[.var-name]#++name++#++)++` [.item-kind]#external#

Allows SkaleManager to remove an schain from the network.
...
[.contract-item]
[[Schains-deleteSchainByRoot-string-]]
==== `++deleteSchainByRoot(++[.var-type]#++string++#++ ++[.var-name]#++name++#++)++` [.item-kind]#external#

Allows SkaleManager to delete a root owned schain.
Upon removal, the space availability of each node is updated.
Emits SchainDeleted event.
Requirements:
- Schain exists.
...
[.contract-item]
[[Schains-restartSchainCreation-string-]]
==== `++restartSchainCreation(++[.var-type]#++string++#++ ++[.var-name]#++name++#++)++` [.item-kind]#external#

Allows SkaleManager contract to restart schain creation by forming a
new schain group.
...
[.contract-item]
[[Schains-verifySchainSignature-uint256-uint256-bytes32-uint256-uint256-uint256-string-]]
==== `++verifySchainSignature(++[.var-type]#++uint256++#++ ++[.var-name]#++signatureA++#++, ++[.var-type]#++uint256++#++ ++[.var-name]#++signatureB++#++, ++[.var-type]#++bytes32++#++ ++[.var-name]#++hash++#++, ++[.var-type]#++uint256++#++ ++[.var-name]#++counter++#++, ++[.var-type]#++uint256++#++ ++[.var-name]#++hashA++#++, ++[.var-type]#++uint256++#++ ++[.var-name]#++hashB++#++, ++[.var-type]#++string++#++ ++[.var-name]#++schainName++#++) → ++[.var-type]#++bool++#++++` [.item-kind]#external#

Checks whether schain group signature is valid.

[.contract-item]
[[Schains-initialize-address-]]
==== `++initialize(++[.var-type]#++address++#++ ++[.var-name]#++newContractsAddress++#++)++` [.item-kind]#public#



[.contract-item]
[[Schains-getSchainPrice-uint256-uint256-]]
...
[.contract-item]
[[Schains-getNodesDataFromTypeOfSchain-uint256-]]
==== `++getNodesDataFromTypeOfSchain(++[.var-type]#++uint256++#++ ++[.var-name]#++typeOfSchain++#++) → ++[.var-type]#++uint256++#++ ++[.var-name]#++numberOfNodes++#++, ++[.var-type]#++uint8++#++ ++[.var-name]#++partOfNode++#++++` [.item-kind]#public#

Returns the number of Nodes and resource divisor that is needed for a
given Schain type.


[.contract-item]
[[Schains-SchainCreated-string-address-uint256-uint256-uint256-uint256-uint16-bytes32-uint256-uint256-]]
==== `++SchainCreated(++[.var-type]#++string++#++ ++[.var-name]#++name++#++, ++[.var-type]#++address++#++ ++[.var-name]#++owner++#++, ++[.var-type]#++uint256++#++ ++[.var-name]#++partOfNode++#++, ++[.var-type]#++uint256++#++ ++[.var-name]#++lifetime++#++, ++[.var-type]#++uint256++#++ ++[.var-name]#++numberOfNodes++#++, ++[.var-type]#++uint256++#++ ++[.var-name]#++deposit++#++, ++[.var-type]#++uint16++#++ ++[.var-name]#++nonce++#++, ++[.var-type]#++bytes32++#++ ++[.var-name]#++schainId++#++, ++[.var-type]#++uint256++#++ ++[.var-name]#++time++#++, ++[.var-type]#++uint256++#++ ++[.var-name]#++gasSpend++#++)++` [.item-kind]#event#

Emitted when an schain is created.

[.contract-item]
[[Schains-SchainDeleted-address-string-bytes32-]]
...
[.contract-item]
[[Schains-NodeRotated-bytes32-uint256-uint256-]]
==== `++NodeRotated(++[.var-type]#++bytes32++#++ ++[.var-name]#++schainId++#++, ++[.var-type]#++uint256++#++ ++[.var-name]#++oldNode++#++, ++[.var-type]#++uint256++#++ ++[.var-name]#++newNode++#++)++` [.item-kind]#event#

Emitted when a node in an schain is rotated.

[.contract-item]
[[Schains-NodeAdded-bytes32-uint256-]]
==== `++NodeAdded(++[.var-type]#++bytes32++#++ ++[.var-name]#++schainId++#++, ++[.var-type]#++uint256++#++ ++[.var-name]#++newNode++#++)++` [.item-kind]#event#

Emitted when a node is added to an schain.

[.contract-item]
[[Schains-SchainNodes-string-bytes32-uint256---uint256-uint256-]]
==== `++SchainNodes(++[.var-type]#++string++#++ ++[.var-name]#++name++#++, ++[.var-type]#++bytes32++#++ ++[.var-name]#++schainId++#++, ++[.var-type]#++uint256[]++#++ ++[.var-name]#++nodesInGroup++#++, ++[.var-type]#++uint256++#++ ++[.var-name]#++time++#++, ++[.var-type]#++uint256++#++ ++[.var-name]#++gasSpend++#++)++` [.item-kind]#event#
