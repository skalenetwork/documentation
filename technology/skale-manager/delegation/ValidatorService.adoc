...
==== +++<a class="heading-anchor" area-hidden="true" name=ValidatorService-checkValidatorExists-uint256->checkValidatorExists</a>+++ `++checkValidatorExists(++[.var-type]#++uint256++#++ ++[.var-name]#++validatorId++#++)++` [.item-kind]#modifier#
...
==== +++<a class="heading-anchor" area-hidden="true" name=ValidatorService-enableValidator-uint256->enableValidator</a>+++ `++enableValidator(++[.var-type]#++uint256++#++ ++[.var-name]#++validatorId++#++)++` [.item-kind]#external#
...
==== +++<a class="heading-anchor" area-hidden="true" name=ValidatorService-disableValidator-uint256->disableValidator</a>+++ `++disableValidator(++[.var-type]#++uint256++#++ ++[.var-name]#++validatorId++#++)++` [.item-kind]#external#
...
==== +++<a class="heading-anchor" area-hidden="true" name=ValidatorService-disableWhitelist-->disableWhitelist</a>+++ `++disableWhitelist()++` [.item-kind]#external#
...
==== +++<a class="heading-anchor" area-hidden="true" name=ValidatorService-requestForNewAddress-address->requestForNewAddress</a>+++ `++requestForNewAddress(++[.var-type]#++address++#++ ++[.var-name]#++newValidatorAddress++#++)++` [.item-kind]#external#
...
==== +++<a class="heading-anchor" area-hidden="true" name=ValidatorService-confirmNewAddress-uint256->confirmNewAddress</a>+++ `++confirmNewAddress(++[.var-type]#++uint256++#++ ++[.var-name]#++validatorId++#++)++` [.item-kind]#external#
...
==== +++<a class="heading-anchor" area-hidden="true" name=ValidatorService-linkNodeAddress-address-bytes->linkNodeAddress</a>+++ `++linkNodeAddress(++[.var-type]#++address++#++ ++[.var-name]#++nodeAddress++#++, ++[.var-type]#++bytes++#++ ++[.var-name]#++sig++#++)++` [.item-kind]#external#
...
==== +++<a class="heading-anchor" area-hidden="true" name=ValidatorService-unlinkNodeAddress-address->unlinkNodeAddress</a>+++ `++unlinkNodeAddress(++[.var-type]#++address++#++ ++[.var-name]#++nodeAddress++#++)++` [.item-kind]#external#
...
==== +++<a class="heading-anchor" area-hidden="true" name=ValidatorService-setValidatorMDA-uint256->setValidatorMDA</a>+++ `++setValidatorMDA(++[.var-type]#++uint256++#++ ++[.var-name]#++minimumDelegationAmount++#++)++` [.item-kind]#external#

Allows a validator to set a minimum delegation amount.

[.contract-item]
[[ValidatorService-setValidatorName-string-]]
==== +++<a class="heading-anchor" area-hidden="true" name=ValidatorService-setValidatorName-string->setValidatorName</a>+++ `++setValidatorName(++[.var-type]#++string++#++ ++[.var-name]#++newName++#++)++` [.item-kind]#external#

Allows a validator to set a new validator name.

[.contract-item]
[[ValidatorService-setValidatorDescription-string-]]
==== +++<a class="heading-anchor" area-hidden="true" name=ValidatorService-setValidatorDescription-string->setValidatorDescription</a>+++ `++setValidatorDescription(++[.var-type]#++string++#++ ++[.var-name]#++newDescription++#++)++` [.item-kind]#external#

Allows a validator to set a new validator description.

[.contract-item]
[[ValidatorService-startAcceptingNewRequests--]]
==== +++<a class="heading-anchor" area-hidden="true" name=ValidatorService-startAcceptingNewRequests-->startAcceptingNewRequests</a>+++ `++startAcceptingNewRequests()++` [.item-kind]#external#
...
==== +++<a class="heading-anchor" area-hidden="true" name=ValidatorService-stopAcceptingNewRequests-->stopAcceptingNewRequests</a>+++ `++stopAcceptingNewRequests()++` [.item-kind]#external#
...
==== +++<a class="heading-anchor" area-hidden="true" name=ValidatorService-getAndUpdateBondAmount-uint256->getAndUpdateBondAmount</a>+++ `++getAndUpdateBondAmount(++[.var-type]#++uint256++#++ ++[.var-name]#++validatorId++#++) → ++[.var-type]#++uint256++#++++` [.item-kind]#external#

Returns the amount of validator bond (self-delegation).

[.contract-item]
[[ValidatorService-getMyNodesAddresses--]]
==== +++<a class="heading-anchor" area-hidden="true" name=ValidatorService-getMyNodesAddresses-->getMyNodesAddresses</a>+++ `++getMyNodesAddresses() → ++[.var-type]#++address[]++#++++` [.item-kind]#external#

Returns node addresses linked to the msg.sender.

[.contract-item]
[[ValidatorService-getTrustedValidators--]]
==== +++<a class="heading-anchor" area-hidden="true" name=ValidatorService-getTrustedValidators-->getTrustedValidators</a>+++ `++getTrustedValidators() → ++[.var-type]#++uint256[]++#++++` [.item-kind]#external#

Returns the list of trusted validators.

[.contract-item]
[[ValidatorService-checkMinimumDelegation-uint256-uint256-]]
==== +++<a class="heading-anchor" area-hidden="true" name=ValidatorService-checkMinimumDelegation-uint256-uint256->checkMinimumDelegation</a>+++ `++checkMinimumDelegation(++[.var-type]#++uint256++#++ ++[.var-name]#++validatorId++#++, ++[.var-type]#++uint256++#++ ++[.var-name]#++amount++#++) → ++[.var-type]#++bool++#++++` [.item-kind]#external#
...
==== +++<a class="heading-anchor" area-hidden="true" name=ValidatorService-checkValidatorAddressToId-address-uint256->checkValidatorAddressToId</a>+++ `++checkValidatorAddressToId(++[.var-type]#++address++#++ ++[.var-name]#++validatorAddress++#++, ++[.var-type]#++uint256++#++ ++[.var-name]#++validatorId++#++) → ++[.var-type]#++bool++#++++` [.item-kind]#external#

Checks whether the validator ID is linked to the validator address.

[.contract-item]
[[ValidatorService-getValidatorIdByNodeAddress-address-]]
==== +++<a class="heading-anchor" area-hidden="true" name=ValidatorService-getValidatorIdByNodeAddress-address->getValidatorIdByNodeAddress</a>+++ `++getValidatorIdByNodeAddress(++[.var-type]#++address++#++ ++[.var-name]#++nodeAddress++#++) → ++[.var-type]#++uint256++#++ ++[.var-name]#++validatorId++#++++` [.item-kind]#external#
...
[.contract-item]
[[ValidatorService-isAuthorizedValidator-uint256-]]
==== +++<a class="heading-anchor" area-hidden="true" name=ValidatorService-isAuthorizedValidator-uint256->isAuthorizedValidator</a>+++ `++isAuthorizedValidator(++[.var-type]#++uint256++#++ ++[.var-name]#++validatorId++#++) → ++[.var-type]#++bool++#++++` [.item-kind]#external#



[.contract-item]
[[ValidatorService-initialize-address-]]
==== +++<a class="heading-anchor" area-hidden="true" name=ValidatorService-initialize-address->initialize</a>+++ `++initialize(++[.var-type]#++address++#++ ++[.var-name]#++contractManagerAddress++#++)++` [.item-kind]#public#



[.contract-item]
[[ValidatorService-getNodeAddresses-uint256-]]
==== +++<a class="heading-anchor" area-hidden="true" name=ValidatorService-getNodeAddresses-uint256->getNodeAddresses</a>+++ `++getNodeAddresses(++[.var-type]#++uint256++#++ ++[.var-name]#++validatorId++#++) → ++[.var-type]#++address[]++#++++` [.item-kind]#public#

Returns a validator's node addresses.

[.contract-item]
[[ValidatorService-validatorExists-uint256-]]
==== +++<a class="heading-anchor" area-hidden="true" name=ValidatorService-validatorExists-uint256->validatorExists</a>+++ `++validatorExists(++[.var-type]#++uint256++#++ ++[.var-name]#++validatorId++#++) → ++[.var-type]#++bool++#++++` [.item-kind]#public#

Checks whether validator ID exists.

[.contract-item]
[[ValidatorService-validatorAddressExists-address-]]
==== +++<a class="heading-anchor" area-hidden="true" name=ValidatorService-validatorAddressExists-address->validatorAddressExists</a>+++ `++validatorAddressExists(++[.var-type]#++address++#++ ++[.var-name]#++validatorAddress++#++) → ++[.var-type]#++bool++#++++` [.item-kind]#public#

Checks whether validator address exists.

[.contract-item]
[[ValidatorService-checkIfValidatorAddressExists-address-]]
==== +++<a class="heading-anchor" area-hidden="true" name=ValidatorService-checkIfValidatorAddressExists-address->checkIfValidatorAddressExists</a>+++ `++checkIfValidatorAddressExists(++[.var-type]#++address++#++ ++[.var-name]#++validatorAddress++#++)++` [.item-kind]#public#

Checks whether validator address exists.

[.contract-item]
[[ValidatorService-getValidator-uint256-]]
==== +++<a class="heading-anchor" area-hidden="true" name=ValidatorService-getValidator-uint256->getValidator</a>+++ `++getValidator(++[.var-type]#++uint256++#++ ++[.var-name]#++validatorId++#++) → ++[.var-type]#++struct ValidatorService.Validator++#++++` [.item-kind]#public#

Returns the Validator struct.

[.contract-item]
[[ValidatorService-getValidatorId-address-]]
==== +++<a class="heading-anchor" area-hidden="true" name=ValidatorService-getValidatorId-address->getValidatorId</a>+++ `++getValidatorId(++[.var-type]#++address++#++ ++[.var-name]#++validatorAddress++#++) → ++[.var-type]#++uint256++#++++` [.item-kind]#public#

Returns the validator ID for the given validator address.

[.contract-item]
[[ValidatorService-isAcceptingNewRequests-uint256-]]
==== +++<a class="heading-anchor" area-hidden="true" name=ValidatorService-isAcceptingNewRequests-uint256->isAcceptingNewRequests</a>+++ `++isAcceptingNewRequests(++[.var-type]#++uint256++#++ ++[.var-name]#++validatorId++#++) → ++[.var-type]#++bool++#++++` [.item-kind]#public#
...
==== +++<a class="heading-anchor" area-hidden="true" name=ValidatorService-ValidatorRegistered-uint256->ValidatorRegistered</a>+++ `++ValidatorRegistered(++[.var-type]#++uint256++#++ ++[.var-name]#++validatorId++#++)++` [.item-kind]#event#

Emitted when a validator registers.

[.contract-item]
[[ValidatorService-ValidatorAddressChanged-uint256-address-]]
==== +++<a class="heading-anchor" area-hidden="true" name=ValidatorService-ValidatorAddressChanged-uint256-address->ValidatorAddressChanged</a>+++ `++ValidatorAddressChanged(++[.var-type]#++uint256++#++ ++[.var-name]#++validatorId++#++, ++[.var-type]#++address++#++ ++[.var-name]#++newAddress++#++)++` [.item-kind]#event#

Emitted when a validator address changes.

[.contract-item]
[[ValidatorService-ValidatorWasEnabled-uint256-]]
==== +++<a class="heading-anchor" area-hidden="true" name=ValidatorService-ValidatorWasEnabled-uint256->ValidatorWasEnabled</a>+++ `++ValidatorWasEnabled(++[.var-type]#++uint256++#++ ++[.var-name]#++validatorId++#++)++` [.item-kind]#event#

Emitted when a validator is enabled.

[.contract-item]
[[ValidatorService-ValidatorWasDisabled-uint256-]]
==== +++<a class="heading-anchor" area-hidden="true" name=ValidatorService-ValidatorWasDisabled-uint256->ValidatorWasDisabled</a>+++ `++ValidatorWasDisabled(++[.var-type]#++uint256++#++ ++[.var-name]#++validatorId++#++)++` [.item-kind]#event#

Emitted when a validator is disabled.

[.contract-item]
[[ValidatorService-NodeAddressWasAdded-uint256-address-]]
==== +++<a class="heading-anchor" area-hidden="true" name=ValidatorService-NodeAddressWasAdded-uint256-address->NodeAddressWasAdded</a>+++ `++NodeAddressWasAdded(++[.var-type]#++uint256++#++ ++[.var-name]#++validatorId++#++, ++[.var-type]#++address++#++ ++[.var-name]#++nodeAddress++#++)++` [.item-kind]#event#

Emitted when a node address is linked to a validator.

[.contract-item]
[[ValidatorService-NodeAddressWasRemoved-uint256-address-]]
==== +++<a class="heading-anchor" area-hidden="true" name=ValidatorService-NodeAddressWasRemoved-uint256-address->NodeAddressWasRemoved</a>+++ `++NodeAddressWasRemoved(++[.var-type]#++uint256++#++ ++[.var-name]#++validatorId++#++, ++[.var-type]#++address++#++ ++[.var-name]#++nodeAddress++#++)++` [.item-kind]#event#
