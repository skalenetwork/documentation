...
[.contract]
[[ValidatorService]]
= ValidatorService:ValidatorService: pass:normal[xref:#ValidatorService[`++ValidatorService++`]]
...
==== `++getAndUpdateBondAmount(++[.var-type]#++uint256++#++ ++[.var-name]#++validatorId++#++) → ++[.var-type]#++uint256++#++++` [.item-kind]#external#
...
==== `++getValidatorIdByNodeAddress(++[.var-type]#++address++#++ ++[.var-name]#++nodeAddress++#++) → ++[.var-type]#++uint256++#++ ++[.var-name]#++validatorId++#++++` [.item-kind]#external#
...
==== `++isAuthorizedValidator(++[.var-type]#++uint256++#++ ++[.var-name]#++validatorId++#++) → ++[.var-type]#++bool++#++++` [.item-kind]#external#
