...
= DelegationController:DelegationController: pass:normal[xref:#DelegationController[`++DelegationController++`]]
...
[.contract-item]
[[DelegationController-getAndUpdateDelegatedByHolderToValidatorNow-address-uint256-]]
==== `++getAndUpdateDelegatedByHolderToValidatorNow(++[.var-type]#++address++#++ ++[.var-name]#++holder++#++, ++[.var-type]#++uint256++#++ ++[.var-name]#++validatorId++#++) → ++[.var-type]#++uint256++#++++` [.item-kind]#external#
