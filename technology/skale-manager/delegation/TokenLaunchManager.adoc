...
:SELLER_ROLE: pass:normal[xref:#TokenLaunchManager-SELLER_ROLE-bytes32[`++SELLER_ROLE++`]]
:approved: pass:normal[xref:#TokenLaunchManager-approved-mapping-address----uint256-[`++approved++`]]
:tokenLaunchIsCompleted: pass:normal[xref:#TokenLaunchManager-tokenLaunchIsCompleted-bool[`++tokenLaunchIsCompleted++`]]
...
:completeTokenLaunch: pass:normal[xref:#TokenLaunchManager-completeTokenLaunch--[`++completeTokenLaunch++`]]
...
:_approveTransfer: pass:normal[xref:#TokenLaunchManager-_approveTransfer-address-uint256-[`++_approveTransfer++`]]
...
:TokenLaunchIsCompleted: pass:normal[xref:#TokenLaunchManager-TokenLaunchIsCompleted-uint256-[`++TokenLaunchIsCompleted++`]]
...
* {xref-TokenLaunchManager-completeTokenLaunch--}[`++completeTokenLaunch()++`]
...
* {xref-TokenLaunchManager-initialize-address-}[`++initialize(contractManagerAddress)++`]
* {xref-TokenLaunchManager-_approveTransfer-address-uint256-}[`++_approveTransfer(walletAddress, value)++`]
...
* {xref-TokenLaunchManager-TokenLaunchIsCompleted-uint256-}[`++TokenLaunchIsCompleted(timestamp)++`]
...
==== `++approveTransfer(++[.var-type]#++address++#++ ++[.var-name]#++walletAddress++#++, ++[.var-type]#++uint256++#++ ++[.var-name]#++value++#++)++` [.item-kind]#external#

Allocates values for `walletAddress`
Requirements:
...
==== `++completeTokenLaunch()++` [.item-kind]#external#

Allows the Seller to complete the token launch process.
...
Allows the Seller to correct a participant's address.
...
Allows the Seller to correct a participant's amount.
Requirements:
- Token launch must not have already completed.
...
Allows a token launch participant to retrieve the entire amount to
...
[.contract-item]
[[TokenLaunchManager-_approveTransfer-address-uint256-]]
==== `++_approveTransfer(++[.var-type]#++address++#++ ++[.var-name]#++walletAddress++#++, ++[.var-type]#++uint256++#++ ++[.var-name]#++value++#++)++` [.item-kind]#internal#

Allows the Seller to approve transfer of tokens to a wallet address.
Emits Approved event.
Requirements:
...
Emitted when a holder is approved for an amount.
...
[.contract-item]
[[TokenLaunchManager-TokenLaunchIsCompleted-uint256-]]
==== `++TokenLaunchIsCompleted(++[.var-type]#++uint256++#++ ++[.var-name]#++timestamp++#++)++` [.item-kind]#event#

Emitted when token launch is completed.
