...
[SlashingTable-setPenalty-string-uint256-]: #SlashingTable-setPenalty-string-uint256-
[SlashingTable-getPenalty-string-]: #SlashingTable-getPenalty-string-
[SlashingTable-initialize-address-]: #SlashingTable-initialize-address-
...
==== `++setPenalty(++[.var-type]#++string++#++ ++[.var-name]#++offense++#++,
++[.var-type]#++uint256++#++ ++[.var-name]#++penalty++#++)++`
[.item-kind]#external#
...
==== `++getPenalty(++[.var-type]#++string++#++ ++[.var-name]#++offense++#++) → ++[.var-type]#++uint256++#++++`
[.item-kind]#external#
