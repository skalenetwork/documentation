...
:addBroadcastedData: pass:normal[xref:#KeyStorage-addBroadcastedData-bytes32-uint256-struct-KeyStorage-KeyShare---struct-G2Operations-G2Point---[`++addBroadcastedData++`]]
...
:computePublicValues: pass:normal[xref:#KeyStorage-computePublicValues-bytes32-struct-G2Operations-G2Point---[`++computePublicValues++`]]
:verify: pass:normal[xref:#KeyStorage-verify-bytes32-uint256-uint256-uint256-struct-G2Operations-G2Point-[`++verify++`]]
:getBroadcastedData: pass:normal[xref:#KeyStorage-getBroadcastedData-bytes32-uint256-[`++getBroadcastedData++`]]
:getSecretKeyShare: pass:normal[xref:#KeyStorage-getSecretKeyShare-bytes32-uint256-uint256-[`++getSecretKeyShare++`]]
:getVerificationVector: pass:normal[xref:#KeyStorage-getVerificationVector-bytes32-uint256-[`++getVerificationVector++`]]
...
:getBLSPublicKey: pass:normal[xref:#KeyStorage-getBLSPublicKey-bytes32-uint256-[`++getBLSPublicKey++`]]
...
.Functions
--
* {xref-KeyStorage-addBroadcastedData-bytes32-uint256-struct-KeyStorage-KeyShare---struct-G2Operations-G2Point---}[`++addBroadcastedData(groupIndex, indexInSchain, secretKeyContribution, verificationVector)++`]
* {xref-KeyStorage-deleteKey-bytes32-}[`++deleteKey(groupIndex)++`]
* {xref-KeyStorage-initPublicKeyInProgress-bytes32-}[`++initPublicKeyInProgress(groupIndex)++`]
* {xref-KeyStorage-adding-bytes32-struct-G2Operations-G2Point-}[`++adding(groupIndex, value)++`]
* {xref-KeyStorage-finalizePublicKey-bytes32-}[`++finalizePublicKey(groupIndex)++`]
* {xref-KeyStorage-computePublicValues-bytes32-struct-G2Operations-G2Point---}[`++computePublicValues(groupIndex, verificationVector)++`]
* {xref-KeyStorage-verify-bytes32-uint256-uint256-uint256-struct-G2Operations-G2Point-}[`++verify(groupIndex, nodeToComplaint, fromNodeToComplaint, secretNumber, multipliedShare)++`]
* {xref-KeyStorage-getBroadcastedData-bytes32-uint256-}[`++getBroadcastedData(groupIndex, nodeIndex)++`]
* {xref-KeyStorage-getSecretKeyShare-bytes32-uint256-uint256-}[`++getSecretKeyShare(groupIndex, nodeIndex, index)++`]
* {xref-KeyStorage-getVerificationVector-bytes32-uint256-}[`++getVerificationVector(groupIndex, nodeIndex)++`]
* {xref-KeyStorage-getCommonPublicKey-bytes32-}[`++getCommonPublicKey(groupIndex)++`]
* {xref-KeyStorage-getPreviousPublicKey-bytes32-}[`++getPreviousPublicKey(groupIndex)++`]
* {xref-KeyStorage-getAllPreviousPublicKeys-bytes32-}[`++getAllPreviousPublicKeys(groupIndex)++`]
* {xref-KeyStorage-getBLSPublicKey-bytes32-uint256-}[`++getBLSPublicKey(groupIndex, nodeIndex)++`]
...
[.contract-item]
[[KeyStorage-addBroadcastedData-bytes32-uint256-struct-KeyStorage-KeyShare---struct-G2Operations-G2Point---]]
==== `++addBroadcastedData(++[.var-type]#++bytes32++#++ ++[.var-name]#++groupIndex++#++, ++[.var-type]#++uint256++#++ ++[.var-name]#++indexInSchain++#++, ++[.var-type]#++struct KeyStorage.KeyShare[]++#++ ++[.var-name]#++secretKeyContribution++#++, ++[.var-type]#++struct G2Operations.G2Point[]++#++ ++[.var-name]#++verificationVector++#++)++` [.item-kind]#external#



[.contract-item]
[[KeyStorage-deleteKey-bytes32-]]
==== `++deleteKey(++[.var-type]#++bytes32++#++ ++[.var-name]#++groupIndex++#++)++` [.item-kind]#external#



[.contract-item]
[[KeyStorage-initPublicKeyInProgress-bytes32-]]
==== `++initPublicKeyInProgress(++[.var-type]#++bytes32++#++ ++[.var-name]#++groupIndex++#++)++` [.item-kind]#external#



[.contract-item]
[[KeyStorage-adding-bytes32-struct-G2Operations-G2Point-]]
==== `++adding(++[.var-type]#++bytes32++#++ ++[.var-name]#++groupIndex++#++, ++[.var-type]#++struct G2Operations.G2Point++#++ ++[.var-name]#++value++#++)++` [.item-kind]#external#



[.contract-item]
[[KeyStorage-finalizePublicKey-bytes32-]]
==== `++finalizePublicKey(++[.var-type]#++bytes32++#++ ++[.var-name]#++groupIndex++#++)++` [.item-kind]#external#



[.contract-item]
[[KeyStorage-computePublicValues-bytes32-struct-G2Operations-G2Point---]]
==== `++computePublicValues(++[.var-type]#++bytes32++#++ ++[.var-name]#++groupIndex++#++, ++[.var-type]#++struct G2Operations.G2Point[]++#++ ++[.var-name]#++verificationVector++#++)++` [.item-kind]#external#



[.contract-item]
[[KeyStorage-verify-bytes32-uint256-uint256-uint256-struct-G2Operations-G2Point-]]
==== `++verify(++[.var-type]#++bytes32++#++ ++[.var-name]#++groupIndex++#++, ++[.var-type]#++uint256++#++ ++[.var-name]#++nodeToComplaint++#++, ++[.var-type]#++uint256++#++ ++[.var-name]#++fromNodeToComplaint++#++, ++[.var-type]#++uint256++#++ ++[.var-name]#++secretNumber++#++, ++[.var-type]#++struct G2Operations.G2Point++#++ ++[.var-name]#++multipliedShare++#++) → ++[.var-type]#++bool++#++++` [.item-kind]#external#



[.contract-item]
[[KeyStorage-getBroadcastedData-bytes32-uint256-]]
==== `++getBroadcastedData(++[.var-type]#++bytes32++#++ ++[.var-name]#++groupIndex++#++, ++[.var-type]#++uint256++#++ ++[.var-name]#++nodeIndex++#++) → ++[.var-type]#++struct KeyStorage.KeyShare[]++#++, ++[.var-type]#++struct G2Operations.G2Point[]++#++++` [.item-kind]#external#



[.contract-item]
[[KeyStorage-getSecretKeyShare-bytes32-uint256-uint256-]]
==== `++getSecretKeyShare(++[.var-type]#++bytes32++#++ ++[.var-name]#++groupIndex++#++, ++[.var-type]#++uint256++#++ ++[.var-name]#++nodeIndex++#++, ++[.var-type]#++uint256++#++ ++[.var-name]#++index++#++) → ++[.var-type]#++bytes32++#++++` [.item-kind]#external#



[.contract-item]
[[KeyStorage-getVerificationVector-bytes32-uint256-]]
==== `++getVerificationVector(++[.var-type]#++bytes32++#++ ++[.var-name]#++groupIndex++#++, ++[.var-type]#++uint256++#++ ++[.var-name]#++nodeIndex++#++) → ++[.var-type]#++struct G2Operations.G2Point[]++#++++` [.item-kind]#external#



[.contract-item]
[[KeyStorage-getCommonPublicKey-bytes32-]]
==== `++getCommonPublicKey(++[.var-type]#++bytes32++#++ ++[.var-name]#++groupIndex++#++) → ++[.var-type]#++struct G2Operations.G2Point++#++++` [.item-kind]#external#



[.contract-item]
[[KeyStorage-getPreviousPublicKey-bytes32-]]
==== `++getPreviousPublicKey(++[.var-type]#++bytes32++#++ ++[.var-name]#++groupIndex++#++) → ++[.var-type]#++struct G2Operations.G2Point++#++++` [.item-kind]#external#



[.contract-item]
[[KeyStorage-getAllPreviousPublicKeys-bytes32-]]
==== `++getAllPreviousPublicKeys(++[.var-type]#++bytes32++#++ ++[.var-name]#++groupIndex++#++) → ++[.var-type]#++struct G2Operations.G2Point[]++#++++` [.item-kind]#external#



[.contract-item]
[[KeyStorage-getBLSPublicKey-bytes32-uint256-]]
==== `++getBLSPublicKey(++[.var-type]#++bytes32++#++ ++[.var-name]#++groupIndex++#++, ++[.var-type]#++uint256++#++ ++[.var-name]#++nodeIndex++#++) → ++[.var-type]#++struct G2Operations.G2Point++#++++` [.item-kind]#external#



[.contract-item]
[[KeyStorage-initialize-address-]]
