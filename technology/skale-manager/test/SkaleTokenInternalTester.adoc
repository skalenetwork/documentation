...
.Functions
--
* {xref-SkaleTokenInternalTester-constructor-address-address---}[`++constructor(contractManagerAddress, defOps)++`]
...
==== `++constructor(++[.var-type]#++address++#++ ++[.var-name]#++contractManagerAddress++#++, ++[.var-type]#++address[]++#++ ++[.var-name]#++defOps++#++)++` [.item-kind]#public#
