...
* a sufficient balance of ETH in the Community Pool to initiate the exit to Ethereum (link:/docs/developers/products/interchain-messaging-agent/funding-exits[See Funding Exits]).
